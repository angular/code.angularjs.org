...
angular.module('pagesData', [])
  ...
  "api/ng/directive/ngModelOptions": {
    ...
    "searchTerms": {
      ...
      "keywords": "$cancelupdate action actual allows api apply attribute belonging blur bound button called canceled change changes clear control controllers current custom debounce debounced debouncing default delay delimited directive displayed easiest empty escape event events example example-ngmodeloptions-directive-blur example-ngmodeloptions-directive-debounce expires field fields focus focused form html input inputs inside integer invoke js js-angular-release key list loses making matches method milliseconds model module nature ng ngmodel ngmodelcontroller ngmodeloptions object options order override partials place pressed published reference relevant reset scope set space special src string supplied synchronized takes timer trigger triggers tuning update updated updateon updates valid view"
    }
  },
  ...
  "api/ng/directive/ngBindTemplate": {
    ...
    "searchTerms": {
      ...
      "keywords": "api attribute box change content directive element elements enter eval example-example15 expressions form greeting html interpolation js js-angular-release module multiple needed ng ngbind ngbindtemplate option partials replaced span specifies src template text title watch"
    }
  },
  ...
  "api/ng/directive/ngClassEven": {
    ...
    "searchTerms": {
      ...
      "keywords": "ac api applied array class conjunction delimited directive directives eval evaluation exactly example-example20 expression guide html js js-angular-release module names ng ngclass ngclasseven ngclassodd ngrepeat odd partials representing result rows scope space src string work"
    }
  },
  ...
  "api/ng/directive/ngClick": {
    ...
    "searchTerms": {
      ...
      "keywords": "$event allows api behavior click clicked custom directive element evaluate event example-example24 expression guide html js js-angular-release module ng ngclick ngeventdirs object partials src"
    }
  },
  "api/ng/directive/ngDblclick": {
    ...
    "searchTerms": {
      ...
      "keywords": "$event allows api behavior custom dblclick directive evaluate event example-example25 expression guide html js js-angular-release module ng ngdblclick ngeventdirs object partials src"
    }
  },
  "api/ng/directive/ngMousedown": {
    ...
    "searchTerms": {
      ...
      "keywords": "$event allows api behavior custom directive evaluate event example-example26 expression guide html js js-angular-release module mousedown ng ngeventdirs ngmousedown object partials src"
    }
  },
  "api/ng/directive/ngMouseup": {
    ...
    "searchTerms": {
      ...
      "keywords": "$event api behavior custom directive evaluate event example-example27 expression guide html js js-angular-release module mouseup ng ngeventdirs ngmouseup object partials src"
    }
  },
  "api/ng/directive/ngMouseover": {
    ...
    "searchTerms": {
      ...
      "keywords": "$event api behavior custom directive evaluate event example-example28 expression guide html js js-angular-release module mouseover ng ngeventdirs ngmouseover object partials src"
    }
  },
  "api/ng/directive/ngMouseenter": {
    ...
    "searchTerms": {
      ...
      "keywords": "$event api behavior custom directive evaluate event example-example29 expression guide html js js-angular-release module mouseenter ng ngeventdirs ngmouseenter object partials src"
    }
  },
  "api/ng/directive/ngMouseleave": {
    ...
    "searchTerms": {
      ...
      "keywords": "$event api behavior custom directive evaluate event example-example30 expression guide html js js-angular-release module mouseleave ng ngeventdirs ngmouseleave object partials src"
    }
  },
  "api/ng/directive/ngMousemove": {
    ...
    "searchTerms": {
      ...
      "keywords": "$event api behavior custom directive evaluate event example-example31 expression guide html js js-angular-release module mousemove ng ngeventdirs ngmousemove object partials src"
    }
  },
  "api/ng/directive/ngKeydown": {
    ...
    "searchTerms": {
      ...
      "keywords": "$event altkey api behavior custom directive evaluate event example-example32 expression guide html interrogated js js-angular-release keycode keydown module ng ngeventdirs ngkeydown object partials src"
    }
  },
  "api/ng/directive/ngKeyup": {
    ...
    "searchTerms": {
      ...
      "keywords": "$event altkey api behavior custom directive evaluate event example-example33 expression guide html interrogated js js-angular-release keycode keyup module ng ngeventdirs ngkeyup object partials src"
    }
  },
  "api/ng/directive/ngKeypress": {
    ...
    "searchTerms": {
      ...
      "keywords": "$event altkey api behavior custom directive evaluate event example-example34 expression guide html interrogated js js-angular-release keycode keypress module ng ngeventdirs ngkeypress object partials src"
    }
  },
  ...
  "api/ng/directive/ngCopy": {
    ...
    "searchTerms": {
      ...
      "keywords": "$event api behavior copy custom directive evaluate event example-example36 expression guide html input js js-angular-release module ng ngcopy ngeventdirs object partials select src textarea window"
    }
  },
  "api/ng/directive/ngCut": {
    ...
    "searchTerms": {
      ...
      "keywords": "$event api behavior custom cut directive evaluate event example-example37 expression guide html input js js-angular-release module ng ngcut ngeventdirs object partials select src textarea window"
    }
  },
  "api/ng/directive/ngPaste": {
    ...
    "searchTerms": {
      ...
      "keywords": "$event api behavior custom directive evaluate event example-example38 expression guide html input js js-angular-release module ng ngeventdirs ngpaste object partials paste select src textarea window"
    }
  },
  ...
  "api/ng/directive/ngStyle": {
    ...
    "searchTerms": {
      ...
      "keywords": "ac allows api conditionally corresponding css directive element evals example-example47 expression guide html js js-angular-release module names ng ngstyle object partials set src style values"
    }
  },
  ...
  "api/ng/directive/ngTransclude": {
    ...
    "searchTerms": {
      ...
      "keywords": "ac api content directive dom element example-example49 existing html inserted insertion js js-angular-release marks module nearest ng ngtransclude parent partials point removed src transcluded transclusion"
    }
  },
  "api/ng/directive/script": {
    ...
    "searchTerms": {
      "titleWords": "script",
      "keywords": "$templatecache api assigned cache content directive directives element example-example50 guide html js js-angular-release load module ng nginclude ngroute ngview partials script set src template templateurl text type"
    }
  },
  ...
  "api/ng/service/$document": {
    ...
    "searchTerms": {
      "titleWords": "$document",
      "keywords": "$document $window angular api browser document element example-example52 html jqlite jquery js js-angular-release module ng object partials service src window wrapper"
    }
  },
  ...
  "api/ng/filter/currency": {
    ...
    "searchTerms": {
      "titleWords": "currency",
      "keywords": "$1 amount api currency current default displayed example-example54 filter filters formats formatted html identifier input js js-angular-release locale module ng number partials provided src symbol"
    }
  },
  "api/ng/filter/number": {
    ...
    "searchTerms": {
      "titleWords": "number",
      "keywords": "api case computed current decimal decimalplaces default digit empty example-example55 filter filters format formats formatting fraction fractionsize html input js js-angular-release locale module ng number partials pattern places provided returned round rounded size src string text third"
    }
  },
  "api/ng/filter/date": {
    "docType": "filter",
  ...
  "api/ng/filter/json": {
    ...
    "searchTerms": {
      "titleWords": "json",
      "keywords": "allows api arrays automatically binding convert converted curly debugging double example-example57 filter filters html javascript js js-angular-release json module ng notation object partials primitive src string types"
    }
  },
  ...
  "api/ng/filter/limitTo": {
    ...
    "searchTerms": {
      "titleWords": "limitTo",
      "keywords": "api array copied creates elements example-example58 exceeds filter html input items js js-angular-release length limit limited limitto module negative ng number partials positive returned sign source src string sub-array substring trimmed"
    }
  },
  "api/ng/filter/orderBy": {
    ...
    "searchTerms": {
      "titleWords": "orderBy",
      "keywords": "angular api array ascending called comparator control copy descending determine elements equivalent evaluates example example-example59 expression filter function getter html items js js-angular-release module ng object operator optionally order orderby orders partials predicate predicates prefixed property result reverse sort sorted sorting source src string"
    }
  },
  "api/ng/service/$http": {
    "docType": "service",
  ...
  "api/ng/provider/$interpolateProvider": {
    ...
    "searchTerms": {
      ...
      "keywords": "$interpolateprovider api configuring defaults example-example61 html interpolate interpolation js js-angular-release markup module ng partials provider src"
    }
  },
  "api/ng/service/$interpolate": {
    ...
    "searchTerms": {
      ...
      "keywords": "$compile $interpolate $interpolateprovider $parse $sce angular api binding compiles compute configuring context contextual data details embedded escaping evaluation exp expect expression expressions function gettrusted hello html injected interpolate interpolated interpolation js js-angular-release markup module musthaveexpression ng null order parameters partials passes provided refer result return returned returning service set src strict string strings text toequal true trustedcontext uppercase var"
    }
  },
  ...
  "api/ngCookies/service/$cookies": {
    ...
    "searchTerms": {
      "titleWords": "$cookies",
      "keywords": "$cookies $eval access adding api browser cookies created current example-example66 exposed html installed js js-angular-release module ngcookies object partials properties read removing requires service simple src strings"
    }
  },
  ...
  "api/ngSanitize/filter/linky": {
    ...
    "searchTerms": {
      "titleWords": "linky",
      "keywords": "address api email example-example67 filter finds frame html html-linkified http input installed js js-angular-release links linky linky_expression module named ng-bind-html ngsanitize open partials plain requires src supports target text turns window"
    }
  },
  "api/ngSanitize": {
    "docType": "module",
  ...
  "error/$injector/strictdi": {
    ...
    "searchTerms": {
      "titleWords": "strictdi",
      "keywords": "$filter $http $inject $injector $scope angular annotate annotated annotation api application array attempting badcontroller bootstrap bracket controller dependencies dependency directive docs enabled error example explicit explicitly function goodcontroller1 goodcontroller2 html inject injected inline invoke invoked js-angular-release listed mode module myapp names ng ngapp ngdoc notation occurs order partials property provider required running strict strict-di strictdi trailing"
    }
  },
  "error/$injector/unpr": {
    "docType": "error",
  ...
  "guide/expression": {
    ...
    "searchTerms": {
      ...
      "keywords": "$eval $event $parse $rootscope $window access accidental alert angular application binding bindings bugs call clickme clutter code common complex conditional conditionals context control controller controllers core data default defined delegate differences directive directives displaying docs eval evaluate evaluated evaluating evaluation evaluations example example-example93 example-example94 example-example95 example-example96 exception exceptions explicitly expose expression expressions filters flow forgiving format function general generates global guide html intentional invoking items javascript javascript-like js-angular-release language logic loop loops method names ng ngclick ngdoc ngfocus note null object overview partials pass philosophy prevents processes properties purpose reason refer referenceerror response restriction returns scope sense server service simply snippets source statement statements subtle throw throws typeerror undefined user valid view views waiting wasn window write"
    }
  },
  "guide/filter": {
    "docType": "overview",
  ...
  "tutorial": {
    ...
    "searchTerms": {
      "titleWords": "Tutorial",
      "keywords": "access actions alert alert-info allow alt android angular angular-phonecat angularjs animations app application applications apply apps assume automatically background behaving better binding bootstrapping bower bower_components branch browse browser browsers build building catalog cd change changes check checkout chrome class client client-side clone close code comfort command commands commit commits common computer conf configuration configured connect consider construction controllers correctly couple create creates current data day demo dependencies dependency designed details developing development device devices diagram digging directly directory displaying displays docs document dom don download drivers dynamic easier easy end-to-end ensure entire environment examples execute executing exit expected experiments explains extensions faster feedback file files filter finish focus follow framework git github good great guides hack hands-on height helper hosting hours href html http https identify img including injection install installed installer installing instructions interact interacting interaction interest introduced introduction io isolated javascript js js-angular-release karma learn learning leave link list listening loaded local located logic machine main management manager manipulation misc model modern move native needed nganimate ngdoc node node_modules npm number open operates operating option org package partials parts pass phonecat pleasant plug-ins png port practice preconfigured process project protractor provide pull purely pushing re-run read real reasons recommended relies remote repo report repository requests resources response rest runner running scripts security separate serve server services set shorter side simple simulating small smaller smarter source spend src start started static step straight suggestions synch system tagged tasks tells template terminal test testing tests time title tool tools tutorial unit update-webdriver user v0 version versioning versions view views walks watch web web-server webserver width window wire work working works writing"
    }
  },
  "tutorial/step_00": {
    "docType": "tutorial",
  ...
  "tutorial/step_03": {
    ...
    "searchTerms": {
      ...
      "keywords": "__ __move__ __remove__ add adding alert alert-info angular apis app appear application array assertion automatically beforeeach better bind binding binds block body box browser capability change changes changing choice class clear code col-md-10 col-md-2 common completely components container-fluid content content-- controller controllers core correctly count create criteria curlies current data data-binding declaration defined demonstrates depending describe detects developer diagram directive directives display displayed div doc-tutorial-nav doc-tutorial-reset docs dom double easily easy edit effects efficiently element elements end-to-end ensure enter example execute exit expect expected experiments eye fail feature features file filter filtering fine foundation friend full fully function functional gallery gettext good google html https img implemented included input install installed instance invisible issuing jasmine javascript js js-angular-release karma laying learn learned list lives ll loading loads lot manipulation match md model motorola nexus ng ng-app ng-bind-template ng-controller ng-model ng-repeat ngbind ngbindtemplate ngcontroller ngdoc ngrepeat note notice noticed npm number parent partials pass perfect phone phonecat phonecatapp phonelist phonelistctrl phones png prefixed prior process protractor query re-run read readable records reflect regressions reload repeater repeaters rerun response result returned row runner running scope search second sendkeys set simple slow snippet solution sorting split src standard status statuselement stays step step_03 step_04 suite summary sync syntax tag template templates terminal test testing tests text title tobe tomatch transparent tutorial type types unit update-webdriver updated updates user var variable ve verifies verify version view webdriver wired wiring won work works write written"
    }
  },
  "tutorial/step_04": {
    "docType": "tutorial",
  ...
  "tutorial/step_12": {
    ...
    "searchTerms": {
      ...
      "keywords": "__ absolute active active-add active-add-active active-remove active-remove-active actual add addclass adding addition adds alert alert-error allows amount angular angular-animate angular-mocks angular-resource angular-route angular-seed angularjs animate animated animatedown animates animateup animating animation animations api app append application applied applying asset attach attaching attribute automatically aware background backwards-compatible basically best block boolean bootstrap bower browsers business callback called calling calls cancelled case change changed changes changing class classes classname cleanup click clicking client closing code collapsing combined common compatible complete completed component configuration consider contained contents control convention conveyor-belt copy core cover craft crazy create created cross css css-enabled data declarations default define defined dependencies dependency depending described description detail developer directive directives display distributed doc-tutorial-nav doc-tutorial-reset docs documentation dom don download earlier easy element elements enable ended enhance ensures enter event example expand extra eye fade fade-in fade-out fades feat file files filter final finishes fire fired flow fluidly forget framework function functionality functions globally going good guide handled height hidden homepage hook hooks href html https idea ie9 image images imageurl img implement include inserted inserting inside install installed isn issued item items javascript javascript-based javascript-enabled jquery js js-angular-release json jumping keeping keyframe learn leave left libraries library license linear link list listed listing ll loaded manipulating matching method mit modern module move moved naming naturally nested newly ng ng- ng-class ng-enter ng-enter-active ng-leave ng-leave-active ng-mouseenter ng-move ng-move-active ng-repeat ng-src ng-view nganimate ngclass ngdoc ngrepeat ngresource ngroute ngview nice nodes note notes notice npm occur occurs offset older opacity operation opportunity order orderby ordinary org overflow padding-bottom padding-top parameter parent partials party passed performing phone phone-detail phone-images phone-list phone-listing phone-thumbs phonecat phonecatanimations phonecatapp phonecatcontrollers phonecatfilters phonecatservices phones pixels place platform plays position positioning positions preconfigured prefixed previous private profile project provided purpose range read reflect registered rel relative removeclass removed removing render rendered rendering repeat repeat-related repeated repeater represents required result return route scope screen selected separately setimage sets shifting short side signal simple single small snippet src standard start started starter starting step step_12 style stylesheet suffix summary support swapper switching takes tap tells template the_end thing thinking thumb thumbnail thumbnails time times top transition transitions trigger triggered true turn tutorial tweak two-class updates var vendor-prefixes version view view-container view-frame views visible web webplatform white wide work working works writing z-index"
    }
  },
  "tutorial/the_end": {
    "docType": "tutorial",
