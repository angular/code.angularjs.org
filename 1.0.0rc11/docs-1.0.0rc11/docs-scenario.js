describe("angular+jqlite", function() {
  ...
  describe("api/angular.module.ng.$parse", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ng.$parse");
    });
  ...
  describe("api/angular.module.ng.$timeout", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ng.$timeout");
    });
  ...
  describe("api/angular.module.ng.$rootElement", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ng.$rootElement");
    });
  ...
  describe("api/angular.module.ng.$compile.directive.Attributes", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ng.$compile.directive.Attributes");
    });
  ...
  describe("api/angular.module.ngMock.$timeout", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ngMock.$timeout");
    });
...
describe("angular+jquery", function() {
  ...
  describe("api/angular.module.ng.$parse", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ng.$parse");
    });
  ...
  describe("api/angular.module.ng.$timeout", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ng.$timeout");
    });
  ...
  describe("api/angular.module.ng.$rootElement", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ng.$rootElement");
    });
  ...
  describe("api/angular.module.ng.$compile.directive.Attributes", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ng.$compile.directive.Attributes");
    });
  ...
  describe("api/angular.module.ngMock.$timeout", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ngMock.$timeout");
    });
