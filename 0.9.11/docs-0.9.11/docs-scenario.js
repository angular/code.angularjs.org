...
describe("fag", function(){
  beforeEach(function(){
    browser().navigateTo("index.html#!fag");
  });
...
describe("guide.contribute", function(){
  beforeEach(function(){
    browser().navigateTo("index.html#!guide.contribute");
  });
...
describe("guide.downloading", function(){
  beforeEach(function(){
    browser().navigateTo("index.html#!guide.downloading");
  });
