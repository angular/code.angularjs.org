...
angular.module('pagesData', [])
  ...
  "api/ng/directive/ngBindTemplate": {
    ...
    "searchTerms": {
      ...
      "keywords": "api attribute box change content directive element elements enter eval example-example13 expressions form greeting html interpolation js js-angular-release module multiple needed ng ngbind ngbindtemplate option partials replaced span specifies src template text title watch"
    }
  },
  ...
  "api/ng/directive/ngClassOdd": {
    ...
    "searchTerms": {
      ...
      "keywords": "ac api applied array class conjunction delimited directive directives eval evaluation exactly example-example17 expression guide html js js-angular-release module names ng ngclass ngclasseven ngclassodd ngrepeat odd partials representing result rows scope space src string work"
    }
  },
  ...
  "api/ng/directive/ngClick": {
    ...
    "searchTerms": {
      ...
      "keywords": "$event allows api behavior click clicked custom directive element evaluate example-example22 expression guide html js js-angular-release module ng ngclick ngeventdirs object partials src"
    }
  },
  ...
  "api/ng/directive/ngStyle": {
    ...
    "searchTerms": {
      ...
      "keywords": "ac allows api conditionally corresponding css directive element evals example-example45 expression guide html js js-angular-release module names ng ngstyle object partials set src style values"
    }
  },
  ...
  "api/ng/directive/ngTransclude": {
    ...
    "searchTerms": {
      ...
      "keywords": "ac api content directive dom element example-example47 existing html inserted insertion js js-angular-release marks module nearest ng ngtransclude parent partials point removed src transcluded transclusion"
    }
  },
  "api/ng/directive/script": {
    ...
    "searchTerms": {
      "titleWords": "script",
      "keywords": "$templatecache api assigned cache content directive directives element example-example48 guide html js js-angular-release load module ng nginclude ngroute ngview partials script set src template templateurl text type"
    }
  },
  ...
  "api/ng/service/$document": {
    ...
    "searchTerms": {
      "titleWords": "$document",
      "keywords": "$document $window angular api browser document element example-example50 html jqlite jquery js js-angular-release module ng object partials service src window wrapper"
    }
  },
  ...
  "api/ng/filter/currency": {
    ...
    "searchTerms": {
      "titleWords": "currency",
      "keywords": "$1 amount api currency current default displayed example-example52 filter filters formats formatted html identifier input js js-angular-release locale module ng number partials provided src symbol"
    }
  },
  "api/ng/filter/number": {
    ...
    "searchTerms": {
      "titleWords": "number",
      "keywords": "api case computed current decimal decimalplaces default digit empty example-example53 filter filters format formats formatting fraction fractionsize html input js js-angular-release locale module ng number partials pattern places provided returned round rounded size src string text third"
    }
  },
  "api/ng/filter/date": {
    "docType": "filter",
  ...
  "api/ng/filter/json": {
    ...
    "searchTerms": {
      "titleWords": "json",
      "keywords": "allows api arrays automatically binding convert converted curly debugging double example-example55 filter filters html javascript js js-angular-release json module ng notation object partials primitive src string types"
    }
  },
  ...
  "api/ng/filter/limitTo": {
    ...
    "searchTerms": {
      "titleWords": "limitTo",
      "keywords": "api array copied creates elements example-example56 exceeds filter html input items js js-angular-release length limit limited limitto module negative ng number partials positive returned sign source src string sub-array substring trimmed"
    }
  },
  "api/ng/filter/orderBy": {
    ...
    "searchTerms": {
      "titleWords": "orderBy",
      "keywords": "angular api array ascending called comparator control copy descending determine elements equivalent evaluates example example-example57 expression filter function getter html items js js-angular-release module ng object operator optionally order orderby orders partials predicate predicates prefixed property result reverse sort sorted sorting source src string"
    }
  },
  "api/ng/service/$http": {
    "docType": "service",
  ...
  "api/ng/provider/$interpolateProvider": {
    ...
    "searchTerms": {
      ...
      "keywords": "$interpolateprovider api configuring defaults example-example59 html interpolate interpolation js js-angular-release markup module ng partials provider src"
    }
  },
  ...
  "api/ngCookies/service/$cookies": {
    ...
    "searchTerms": {
      "titleWords": "$cookies",
      "keywords": "$cookies $eval access adding api browser cookies created current example-example64 exposed html installed js js-angular-release module ngcookies object partials properties read removing requires service simple src strings"
    }
  },
  ...
  "api/ngSanitize/filter/linky": {
    ...
    "searchTerms": {
      "titleWords": "linky",
      "keywords": "address api email example-example65 filter finds frame html html-linkified http input installed js js-angular-release links linky linky_expression module named ng-bind-html ngsanitize open partials plain requires src supports target text turns window"
    }
  },
  "api/ngSanitize": {
    "docType": "module",
  ...
  "error/ng/btstrpd": {
    ...
    "searchTerms": {
      "titleWords": "btstrpd",
      "keywords": "accidentally angular angularjs app application body bootrapping bootstrap bootstrapped btstrpd calling docs document element error html js js-angular-release load myapp ng-app ng:btstrpd ngdoc note occurs partials purposes src throw"
    }
  },
  "error/ng/cpi": {
    "docType": "error",
