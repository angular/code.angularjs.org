...
f}}g.resource=m;return g}),r=r["finally"](function(){m.$resolved=!0;!F&&G&&(m.$cancelRequest=e.noop,O.cancel(L),B=L=s.timeout=null)}),r=r.then(function(a){var c=E(a);(y||H)(c,a.headers);return c},J||K?function(a){J&&C(a);return K?z(a):N.reject(a)}:void 0);J&&!K&&r.catch(H);return F?r:(m.$promise=r,m.$resolved=!1,G&&(m.$cancelRequest=w),m)};l.prototype["$"+c]=function(a,b,e){A(a)&&(e=b,b=a,a={});a=l[c].call(this,a,this,b,e);return a.$promise||a}});l.bind=function(a){return z(q,p({},h,a),w)};return l}
var H=e.noop,u=e.forEach,p=e.extend,R=e.copy,A=e.isFunction,S=e.$$encodeUriQuery,T=e.$$encodeUriSegment;E.prototype={setUrlParams:function(d,h,n){var f=this,b=n||f.template,v,l,p="",a=f.urlParams=Object.create(null);u(b.split(/\W/),function(c){if("hasOwnProperty"===c)throw D("badname");!/^\d+$/.test(c)&&c&&(new RegExp("(^|[^\\\\]):"+c+"(\\W|$)")).test(b)&&(a[c]={isQueryParamValue:(new RegExp("\\?.*=:"+c+"(?:\\W|$)")).test(b)})});b=b.replace(/\\:/g,":");b=b.replace(t,function(a){p=a;return""});h=h||
{};u(f.urlParams,function(a,d){v=h.hasOwnProperty(d)?h[d]:f.defaults[d];e.isDefined(v)&&null!==v?(l=a.isQueryParamValue?S(v,!0):T(v),b=b.replace(new RegExp(":"+d+"(\\W|$)","g"),function(a,c){return l+c})):b=b.replace(new RegExp("(/?):"+d+"(\\W|$)","g"),function(a,c,b){return"/"===b.charAt(0)?b:c+b})});f.defaults.stripTrailingSlashes&&(b=b.replace(/\/+$/,"")||"/");b=b.replace(/\/\.(?=\w+($|\?))/,".");d.url=p+b.replace(/\/\\\./,"/.");u(h,function(a,b){f.urlParams[b]||(d.params=d.params||{},d.params[b]=
