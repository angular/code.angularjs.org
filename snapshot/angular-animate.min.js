/*
 AngularJS v1.5.0-build.4475+sha.e020b89
...
case 1:if(1===a[0].nodeType)return a;break;default:return H(ea(a))}if(1===a.nodeType)return H(a)}function ea(a){if(!a[0])return a;for(var b=0;b<a.length;b++){var c=a[b];if(1==c.nodeType)return c}}function Ma(a,b,c){x(b,function(b){a.addClass(b,c)})}function Na(a,b,c){x(b,function(b){a.removeClass(b,c)})}function O(a){return function(b,c){c.addClass&&(Ma(a,b,c.addClass),c.addClass=null);c.removeClass&&(Na(a,b,c.removeClass),c.removeClass=null)}}function na(a){a=a||{};if(!a.$$prepared){var b=a.domOperation||
K;a.domOperation=function(){a.$$domOperationFired=!0;b();b=K};a.$$prepared=!0}return a}function ia(a,b){za(a,b);Aa(a,b)}function za(a,b){b.from&&(a.css(b.from),b.from=null)}function Aa(a,b){b.to&&(a.css(b.to),b.to=null)}function S(a,b,c){var d=(b.addClass||"")+" "+(c.addClass||""),f=(b.removeClass||"")+" "+(c.removeClass||"");a=Oa(a.attr("class"),d,f);c.preparationClasses&&(b.preparationClasses=V(c.preparationClasses,b.preparationClasses),delete c.preparationClasses);d=b.domOperation!==K?b.domOperation:
...
return u}function G(a){return a instanceof n.element?a[0]:a}function Pa(a,b,c){var d="";b&&(d=U(b,"ng-",!0));c.addClass&&(d=V(d,U(c.addClass,"-add")));c.removeClass&&(d=V(d,U(c.removeClass,"-remove")));d.length&&(c.preparationClasses=d,a.addClass(d))}function oa(a,b){var c=b?"-"+b+"s":"";ja(a,[ka,c]);return[ka,c]}function qa(a,b){var c=b?"paused":"",d=W+"PlayState";ja(a,[d,c]);return[d,c]}function ja(a,b){a.style[b[0]]=b[1]}function V(a,b){return a?b?a+" "+b:a:b}function Ca(a,b,c){var d=Object.create(null),
...
(P="transition",ua="transitionend");sa(F.onanimationend)&&X(F.onwebkitanimationend)?(W="WebkitAnimation",va="webkitAnimationEnd animationend"):(W="animation",va="animationend");var pa=W+"Delay",wa=W+"Duration",ka=P+"Delay";F=P+"Duration";var Ja=n.$$minErr("ng"),Ra={transitionDuration:F,transitionDelay:ka,transitionProperty:P+"Property",animationDuration:wa,animationDelay:pa,animationIterationCount:W+"IterationCount"},Sa={transitionDuration:F,transitionDelay:ka,animationDuration:wa,animationDelay:pa};
...
w.structural)||(I="animate"===w.event&&0<Object.keys(w.options.to||{}).length||c(w.options));if(!I)return A(),z(a),k;var n=(h.counter||0)+1;w.counter=n;q(a,1,w);u.$$postDigest(function(){var b=l.get(m),h=!b,b=b||{},d=0<(a.parent()||[]).length&&("animate"===b.event||b.structural||c(b.options));if(h||b.counter!==n||!d){h&&(p(a,s),ia(a,s));if(h||t&&b.event!==e)s.domOperation(),k.end();d||z(a)}else e=!b.structural&&c(b.options,!0)?"setClass":b.event,q(a,2),b=v(a,e,b.options),b.done(function(b){A(!b);
...
(A(),u.$$postDigest(function(){u.$$postDigest(function(){null===N&&(N=!0)})}))}),m={},e=a.classNameFilter(),Ua=e?function(a){return e.test(a)}:function(){return!0},p=O(k);return{on:function(a,b,e){b=ea(b);m[a]=m[a]||[];m[a].push({node:b,callback:e})},off:function(a,b,e){function c(a,b,e){var d=ea(b);return a.filter(function(a){return!(a.node===d&&(!e||a.callback===e))})}var d=m[a];d&&(m[a]=1===arguments.length?null:c(d,b,e))},pin:function(a,b){xa(ta(a),"element","not an element");xa(ta(b),"parentElement",
...
b.put(g,f);c=f;g=c.animationDelay;f=c.transitionDelay;c.maxDelay=g&&f?Math.max(g,f):g||f;c.maxDuration=Math.max(c.animationDuration*c.animationIterationCount,c.transitionDuration);return c}var ba=O(f),w=0,y=[];return function(a,c){function d(){l()}function q(){l(!0)}function l(b){if(!(la||s&&F)){la=!0;F=!1;e.$$skipPreparationClasses||f.removeClass(a,ca);f.removeClass(a,ea);qa(p,!1);oa(p,!1);x(y,function(a){p.style[a[0]]=""});ba(a,e);ia(a,e);Object.keys(t).length&&x(t,function(a,b){a?p.style.setProperty(b,
a):p.style.removeProperty(b)});if(e.onDone)e.onDone();da&&da.length&&a.off(da.join(" "),A);H&&H.complete(!b)}}function D(a){r.blockTransition&&oa(p,a);r.blockKeyframeAnimation&&qa(p,!!a)}function w(){H=new u({end:d,cancel:q});I(K);l();return{$$willAnimate:!1,start:function(){return H},end:d}}function A(a){a.stopPropagation();var b=a.originalEvent||a;a=b.$manualTimeStamp||Date.now();b=parseFloat(b.elapsedTime.toFixed(3));Math.max(a-V,0)>=O&&b>=J&&(s=!0,l())}function m(){function b(){if(!la){D(!1);
x(y,function(a){p.style[a[0]]=a[1]});ba(a,e);f.addClass(a,ea);if(r.recalculateTimingStyles){ma=p.className+" "+ca;ha=Ia(p,ma);E=C(p,ma,ha);Y=E.maxDelay;ga=Math.max(Y,0);J=E.maxDuration;if(0===J){l();return}r.hasTransitions=0<E.transitionDuration;r.hasAnimations=0<E.animationDuration}r.applyAnimationDelay&&(Y="boolean"!==typeof e.delay&&ra(e.delay)?parseFloat(e.delay):Y,ga=Math.max(Y,0),E.animationDelay=Y,Z=[pa,Y+"s"],y.push(Z),p.style[Z[0]]=Z[1]);O=1E3*ga;S=1E3*J;if(e.easing){var d,g=e.easing;r.hasTransitions&&
(d=P+"TimingFunction",y.push([d,g]),p.style[d]=g);r.hasAnimations&&(d=W+"TimingFunction",y.push([d,g]),p.style[d]=g)}E.transitionDuration&&da.push(ua);E.animationDuration&&da.push(va);V=Date.now();var m=O+1.5*S;d=V+m;var g=a.data("$$animateCss")||[],q=!0;if(g.length){var h=g[0];(q=d>h.expectedEndTime)?B.cancel(h.timer):g.push(l)}q&&(m=B(c,m,!1),g[0]={timer:m,expectedEndTime:d},g.push(l),a.data("$$animateCss",g));if(da.length)a.on(da.join(" "),A);e.to&&(e.cleanupStyles&&Fa(t,p,Object.keys(e.to)),Aa(a,
e))}}function c(){var b=a.data("$$animateCss");if(b){for(var d=1;d<b.length;d++)b[d]();a.removeData("$$animateCss")}}if(!la)if(p.parentNode){var d=function(a){if(s)F&&a&&(F=!1,l());else if(F=!a,E.animationDuration)if(a=qa(p,F),F)y.push(a);else{var b=y,c=b.indexOf(a);0<=a&&b.splice(c,1)}},g=0<aa&&(E.transitionDuration&&0===T.transitionDuration||E.animationDuration&&0===T.animationDuration)&&Math.max(T.animationDelay,T.transitionDelay);g?B(b,Math.floor(g*aa*1E3),!1):b();M.resume=function(){d(!0)};M.pause=
function(){d(!1)}}else l()}var e=Ga(c),t={},p=G(a);if(!p||!p.parentNode||!n.enabled())return w();var e=na(e),y=[],v=a.attr("class"),h=Ka(e),la,F,s,H,M,ga,O,J,S,V,da=[];if(0===e.duration||!g.animations&&!g.transitions)return w();var fa=e.event&&$(e.event)?e.event.join(" "):e.event,X="",Q="";fa&&e.structural?X=U(fa,"ng-",!0):fa&&(X=fa);e.addClass&&(Q+=U(e.addClass,"-add"));e.removeClass&&(Q.length&&(Q+=" "),Q+=U(e.removeClass,"-remove"));e.applyClassesEarly&&Q.length&&ba(a,e);var ca=[X,Q].join(" ").trim(),
ma=v+" "+ca,ea=U(ca,"-active"),v=h.to&&0<Object.keys(h.to).length;if(!(0<(e.keyframeStyle||"").length||v||ca))return w();var ha,T;0<e.stagger?(h=parseFloat(e.stagger),T={transitionDelay:h,animationDelay:h,transitionDuration:0,animationDuration:0}):(ha=Ia(p,ma),T=k(p,ca,ha,Sa));e.$$skipPreparationClasses||f.addClass(a,ca);e.transitionStyle&&(h=[P,e.transitionStyle],ja(p,h),y.push(h));0<=e.duration&&(h=0<p.style[P].length,h=Da(e.duration,h),ja(p,h),y.push(h));e.keyframeStyle&&(h=[W,e.keyframeStyle],
ja(p,h),y.push(h));var aa=T?0<=e.staggerIndex?e.staggerIndex:b.count(ha):0;(fa=0===aa)&&!e.skipBlocking&&oa(p,9999);var E=C(p,ma,ha),Y=E.maxDelay;ga=Math.max(Y,0);J=E.maxDuration;var r={};r.hasTransitions=0<E.transitionDuration;r.hasAnimations=0<E.animationDuration;r.hasTransitionAll=r.hasTransitions&&"all"==E.transitionProperty;r.applyTransitionDuration=v&&(r.hasTransitions&&!r.hasTransitionAll||r.hasAnimations&&!r.hasTransitions);r.applyAnimationDuration=e.duration&&r.hasAnimations;r.applyTransitionDelay=
ra(e.delay)&&(r.applyTransitionDuration||r.hasTransitions);r.applyAnimationDelay=ra(e.delay)&&r.hasAnimations;r.recalculateTimingStyles=0<Q.length;if(r.applyTransitionDuration||r.applyAnimationDuration)J=e.duration?parseFloat(e.duration):J,r.applyTransitionDuration&&(r.hasTransitions=!0,E.transitionDuration=J,h=0<p.style[P+"Property"].length,y.push(Da(J,h))),r.applyAnimationDuration&&(r.hasAnimations=!0,E.animationDuration=J,y.push([wa,J+"s"]));if(0===J&&!r.recalculateTimingStyles)return w();if(null!=
e.delay){var Z;"boolean"!==typeof e.delay&&(Z=parseFloat(e.delay),ga=Math.max(Z,0));r.applyTransitionDelay&&y.push([ka,Z+"s"]);r.applyAnimationDelay&&y.push([pa,Z+"s"])}null==e.duration&&0<E.transitionDuration&&(r.recalculateTimingStyles=r.recalculateTimingStyles||fa);O=1E3*ga;S=1E3*J;e.skipBlocking||(r.blockTransition=0<E.transitionDuration,r.blockKeyframeAnimation=0<E.animationDuration&&0<T.animationDelay&&0===T.animationDuration);e.from&&(e.cleanupStyles&&Fa(t,p,Object.keys(e.from)),za(a,e));r.blockTransition||
r.blockKeyframeAnimation?D(J):e.skipBlocking||oa(p,!1);return{$$willAnimate:!0,end:d,start:function(){if(!la)return M={end:d,cancel:q,resume:null,pause:null},H=new u(M),I(m),H}}}}]}]).provider("$$animateCssDriver",["$$animationProvider",function(a){a.drivers.push("$$animateCssDriver");this.$get=["$animateCss","$rootScope","$$AnimateRunner","$rootElement","$sniffer","$$jqLite","$document",function(a,c,d,f,u,B,t){function g(a){return a.replace(/\bng-\S+\b/g,"")}function v(a,b){M(a)&&(a=a.split(" "));
...
b?(L="leave",H="afterLeave"):(L="before"+b.charAt(0).toUpperCase()+b.substr(1),H=b);"enter"!==b&&"move"!==b&&(y=I(a,b,v,w,L));z=I(a,b,v,w,H)}if(y||z)return{start:function(){function b(c){g=!0;n();ia(a,v);k.complete(c)}var d,f=[];y&&f.push(function(a){d=y(a)});f.length?f.push(function(a){n();a(!0)}):n();z&&f.push(function(a){d=z(a)});var g=!1,k=new c({end:function(){g||((d||K)(void 0),b(void 0))},cancel:function(){g||((d||K)(!0),b(!0))}});c.chain(f,b);return k}}}}]}]).provider("$$animateJsDriver",
