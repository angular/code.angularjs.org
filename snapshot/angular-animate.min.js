/*
 AngularJS v1.5.6-build.4782+sha.3dcc016
 (c) 2010-2016 Google, Inc. http://angularjs.org
 License: MIT
*/
(function(V,q){'use strict';function Ba(a,b,c){if(!a)throw Oa("areq",b||"?",c||"required");return a}function Ca(a,b){if(!a&&!b)return"";if(!a)return b;if(!b)return a;ea(a)&&(a=a.join(" "));ea(b)&&(b=b.join(" "));return a+" "+b}function Pa(a){var b={};a&&(a.to||a.from)&&(b.to=a.to,b.from=a.from);return b}function Y(a,b,c){var d="";a=ea(a)?a:a&&S(a)&&a.length?a.split(/\s+/):[];r(a,function(a,f){a&&0<a.length&&(d+=0<f?" ":"",d+=c?b+a:a+b)});return d}function Qa(a){if(a instanceof C)switch(a.length){case 0:return[];
...
N=a.parent();var h=pa(h),p=new z,f=H();ea(h.addClass)&&(h.addClass=h.addClass.join(" "));h.addClass&&!S(h.addClass)&&(h.addClass=null);ea(h.removeClass)&&(h.removeClass=h.removeClass.join(" "));h.removeClass&&!S(h.removeClass)&&(h.removeClass=null);h.from&&!wa(h.from)&&(h.from=null);h.to&&!wa(h.to)&&(h.to=null);if(!t)return l(),p;w=[t.className,h.addClass,h.removeClass].join(" ");if(!G(w))return l(),p;var y=0<=["enter","move","leave"].indexOf(I),x=L(),u=!oa||x||g.get(t);w=!u&&B.get(t)||{};var da=
!!w.state;u||da&&1===w.state||(u=!O(a,N,I));if(u)return x&&k(p,I,"start"),l(),x&&k(p,I,"close"),p;y&&ka(a);x={structural:y,element:a,event:I,addClass:h.addClass,removeClass:h.removeClass,close:l,options:h,runner:p};if(da){if(d("skip",a,x,w)){if(2===w.state)return l(),p;J(a,w,x);return w.runner}if(d("cancel",a,x,w))if(2===w.state)w.runner.end();else if(w.structural)w.close();else return J(a,w,x),w.runner;else if(d("join",a,x,w))if(2===w.state)J(a,x,{});else return Ua(a,y?I:null,h),I=x.event=w.event,
h=J(a,w,x),w.runner}else J(a,x,{});(da=x.structural)||(da="animate"===x.event&&0<Object.keys(x.options.to||{}).length||e(x));if(!da)return l(),m(a),p;var A=(w.counter||0)+1;x.counter=A;P(a,1,x);c.$$postDigest(function(){var b=B.get(t),c=!b,b=b||{},g=0<(a.parent()||[]).length&&("animate"===b.event||b.structural||e(b));if(c||b.counter!==A||!g){c&&(Na(a,h),ia(a,h));if(c||y&&b.event!==I)h.domOperation(),p.end();g||m(a)}else I=!b.structural&&e(b,!0)?"setClass":b.event,P(a,2),b=Ya(a,I,b.options),p.setHost(b),
k(p,I,"start",{}),b.done(function(b){l(!b);(b=B.get(t))&&b.counter===A&&m(D(a));k(p,I,"close",{})})});return p}function ka(a){a=D(a).querySelectorAll("[data-ng-animate]");r(a,function(a){var b=parseInt(a.getAttribute("data-ng-animate")),c=B.get(a);if(c)switch(b){case 2:c.runner.end();case 1:B.remove(a)}})}function m(a){a=D(a);a.removeAttribute("data-ng-animate");B.remove(a)}function h(a,b){return D(a)===D(b)}function O(a,b,c){c=C(u[0].body);var d=h(a,c)||"HTML"===a[0].nodeName,s=h(a,f),k=!1,l,e=g.get(D(a));
(a=C.data(a[0],"$ngAnimatePin"))&&(b=a);for(b=D(b);b;){s||(s=h(b,f));if(1!==b.nodeType)break;a=B.get(b)||{};if(!k){var p=g.get(b);if(!0===p&&!1!==e){e=!0;break}else!1===p&&(e=!1);k=a.structural}if(F(l)||!0===l)a=C.data(b,"$$ngAnimateChildren"),$(a)&&(l=a);if(k&&!1===l)break;d||(d=h(b,c));if(d&&s)break;if(!s&&(a=C.data(b,"$ngAnimatePin"))){b=D(a);continue}b=b.parentNode}return(!k||l)&&!0!==e&&s&&d}function P(a,b,c){c=c||{};c.state=b;a=D(a);a.setAttribute("data-ng-animate",b);c=(b=B.get(a))?Fa(b,c):
c;B.put(a,c)}var B=new R,g=new R,oa=null,k=c.$watch(function(){return 0===sa.totalPendingRequests},function(a){a&&(k(),c.$$postDigest(function(){c.$$postDigest(function(){null===oa&&(oa=!0)})}))}),l={},da=a.classNameFilter(),G=da?function(a){return da.test(a)}:function(){return!0},Na=W(A),x=V.Node.prototype.contains||function(a){return this===a||!!(this.compareDocumentPosition(a)&16)},ca={on:function(a,b,c){var g=ta(b);l[a]=l[a]||[];l[a].push({node:g,callback:c});C(b).on("$destroy",function(){B.get(g)||
ca.off(a,b,c)})},off:function(a,b,c){if(1!==arguments.length||q.isString(arguments[0])){var g=l[a];g&&(l[a]=1===arguments.length?null:p(g,b,c))}else for(g in b=arguments[0],l)l[g]=p(l[g],b)},pin:function(a,b){Ba(xa(a),"element","not an element");Ba(xa(b),"parentElement","not an element");a.data("$ngAnimatePin",b)},push:function(a,b,c,g){c=c||{};c.domOperation=g;return t(a,b,c)},enabled:function(a,b){var c=arguments.length;if(0===c)b=!!oa;else if(xa(a)){var d=D(a),h=g.get(d);1===c?b=!h:g.put(d,!b)}else b=
oa=!!a;return b}};return ca}]}]).provider("$$animation",["$animateProvider",function(a){function b(a){return a.data("$$animationRunner")}var c=this.drivers=[];this.$get=["$$jqLite","$rootScope","$injector","$$AnimateRunner","$$HashMap","$$rAFScheduler",function(a,e,f,K,v,y){function u(a){function b(a){if(a.processed)return a;a.processed=!0;var d=a.domNode,t=d.parentNode;e.put(d,a);for(var f;t;){if(f=e.get(t)){f.processed||(f=b(f));break}t=t.parentNode}(f||c).children.push(a);return a}var c={children:[]},
d,e=new v;for(d=0;d<a.length;d++){var f=a[d];e.put(f.domNode,a[d]={domNode:f.domNode,fn:f.fn,children:[]})}for(d=0;d<a.length;d++)b(a[d]);return function(a){var b=[],c=[],d;for(d=0;d<a.children.length;d++)c.push(a.children[d]);a=c.length;var e=0,h=[];for(d=0;d<c.length;d++){var f=c[d];0>=a&&(a=e,e=0,b.push(h),h=[]);h.push(f.fn);f.children.forEach(function(a){e++;c.push(a)});a--}h.length&&b.push(h);return b}(c)}var R=[],q=W(a);return function(z,v,A){function N(a){a=a.hasAttribute("ng-animate-ref")?
...
ua(k,!!a)}function O(){C=new f({end:d,cancel:u});sa(Q);m();return{$$willAnimate:!1,start:function(){return C},end:d}}function P(a){a.stopPropagation();var b=a.originalEvent||a;a=b.$manualTimeStamp||Date.now();b=parseFloat(b.elapsedTime.toFixed(3));Math.max(a-V,0)>=F&&b>=M&&(ca=!0,m())}function B(){function b(){if(!L){h(!1);r(l,function(a){k.style[a[0]]=a[1]});N(a,g);e.addClass(a,fa);if(n.recalculateTimingStyles){J=k.className+" "+ha;la=q(k,J);E=A(k,J,la);aa=E.maxDelay;w=Math.max(aa,0);M=E.maxDuration;
if(0===M){m();return}n.hasTransitions=0<E.transitionDuration;n.hasAnimations=0<E.animationDuration}n.applyAnimationDelay&&(aa="boolean"!==typeof g.delay&&va(g.delay)?parseFloat(g.delay):aa,w=Math.max(aa,0),E.animationDelay=aa,ba=[ra,aa+"s"],l.push(ba),k.style[ba[0]]=ba[1]);F=1E3*w;S=1E3*M;if(g.easing){var d,f=g.easing;n.hasTransitions&&(d=T+"TimingFunction",l.push([d,f]),k.style[d]=f);n.hasAnimations&&(d=Z+"TimingFunction",l.push([d,f]),k.style[d]=f)}E.transitionDuration&&ga.push(ya);E.animationDuration&&
ga.push(za);V=Date.now();var B=F+1.5*S;d=V+B;var f=a.data("$$animateCss")||[],y=!0;if(f.length){var p=f[0];(y=d>p.expectedEndTime)?K.cancel(p.timer):f.push(m)}y&&(B=K(c,B,!1),f[0]={timer:B,expectedEndTime:d},f.push(m),a.data("$$animateCss",f));if(ga.length)a.on(ga.join(" "),P);g.to&&(g.cleanupStyles&&Ja(H,k,Object.keys(g.to)),Ea(a,g))}}function c(){var b=a.data("$$animateCss");if(b){for(var d=1;d<b.length;d++)b[d]();a.removeData("$$animateCss")}}if(!L)if(k.parentNode){var d=function(a){if(ca)x&&a&&
(x=!1,m());else if(x=!a,E.animationDuration)if(a=ua(k,x),x)l.push(a);else{var b=l,c=b.indexOf(a);0<=a&&b.splice(c,1)}},f=0<$&&(E.transitionDuration&&0===X.transitionDuration||E.animationDuration&&0===X.animationDuration)&&Math.max(X.animationDelay,X.transitionDelay);f?K(b,Math.floor(f*$*1E3),!1):b();I.resume=function(){d(!0)};I.pause=function(){d(!1)}}else m()}var g=c||{};g.$$prepared||(g=pa(Ka(g)));var H={},k=D(a);if(!k||!k.parentNode||!R.enabled())return O();var l=[],v=a.attr("class"),G=Pa(g),L,
x,ca,C,I,w,F,M,S,V,ga=[];if(0===g.duration||!y.animations&&!y.transitions)return O();var ja=g.event&&ea(g.event)?g.event.join(" "):g.event,W="",U="";ja&&g.structural?W=Y(ja,"ng-",!0):ja&&(W=ja);g.addClass&&(U+=Y(g.addClass,"-add"));g.removeClass&&(U.length&&(U+=" "),U+=Y(g.removeClass,"-remove"));g.applyClassesEarly&&U.length&&N(a,g);var ha=[W,U].join(" ").trim(),J=v+" "+ha,fa=Y(ha,"-active"),v=G.to&&0<Object.keys(G.to).length;if(!(0<(g.keyframeStyle||"").length||v||ha))return O();var la,X;0<g.stagger?
