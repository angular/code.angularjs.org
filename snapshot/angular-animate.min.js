...
Ta={transitionDuration:G,transitionDelay:ja,animationDuration:va,animationDelay:na};r.module("ngAnimate",[]).directive("ngAnimateSwap",["$animate","$rootScope",function(a,b){return{restrict:"A",transclude:"element",terminal:!0,priority:600,link:function(b,d,e,l,O){var D,s;b.$watchCollection(e.ngAnimateSwap||e["for"],function(e){D&&a.leave(D);s&&(s.$destroy(),s=null);if(e||0===e)s=b.$new(),O(s,function(b){D=b;a.enter(b,null,d)})})}}}]).directive("ngAnimateChildren",[function(){return function(a,b,
c){a=c.ngAnimateChildren;r.isString(a)&&0===a.length?b.data("$$ngAnimateChildren",!0):c.$observe("ngAnimateChildren",function(a){b.data("$$ngAnimateChildren","on"===a||"true"===a)})}}]).factory("$$rAFScheduler",["$$rAF",function(a){function b(a){d=d.concat(a);c()}function c(){if(d.length){for(var b=d.shift(),O=0;O<b.length;O++)b[O]();e||a(function(){e||c()})}}var d,e;d=b.queue=[];b.waitUntilQuiet=function(b){e&&e();e=a(function(){e=null;b();c()})};return b}]).provider("$$animateQueue",["$animateProvider",
...
a.end()}function h(b){x.off("$destroy",M);x.removeData("$$animationRunner");r(x,z);ga(x,z);z.domOperation();E&&a.removeClass(x,E);x.removeClass("ng-animate");w.complete(!b)}z=la(z);var q=0<=["enter","move","leave"].indexOf(D),w=new O({end:function(){h()},cancel:function(){h(!0)}});if(!c.length)return h(),w;x.data("$$animationRunner",w);var m=za(x.attr("class"),za(z.addClass,z.removeClass)),E=z.tempClasses;E&&(m+=" "+E,z.tempClasses=null);var L;q&&(L="ng-"+D+"-prepare",a.addClass(x,L));I.push({element:x,
...
(c=c(),c.done(function(a){d(!a)}),xa(a,c)):d()}})});s(y(d))});return w}}]}]).provider("$animateCss",["$animateProvider",function(a){var b=Fa(),c=Fa();this.$get=["$window","$$jqLite","$$AnimateRunner","$timeout","$$forceReflow","$sniffer","$$rAFScheduler","$$animateQueue",function(a,e,l,O,D,s,y,I){function r(a,b){var c=a.parentNode;return(c.$$ngAnimateParentKey||(c.$$ngAnimateParentKey=++K))+"-"+a.getAttribute("class")+"-"+b}function x(g,u,s,h){var q;0<b.count(s)&&(q=c.get(s),q||(u=Y(u,"-stagger"),
...
E);G&&G.complete(!b)}}function w(a){p.blockTransition&&ma(k,a);p.blockKeyframeAnimation&&pa(k,!!a)}function m(){G=new l({end:d,cancel:h});J(R);q();return{$$willAnimate:!1,start:function(){return G},end:d}}function E(a){a.stopPropagation();var b=a.originalEvent||a;a=b.$manualTimeStamp||Date.now();b=parseFloat(b.elapsedTime.toFixed(3));Math.max(a-V,0)>=Q&&b>=N&&(wa=!0,q())}function L(){function b(){if(!y){w(!1);t(v,function(a){k.style[a[0]]=a[1]});u(a,f);e.addClass(a,da);if(p.recalculateTimingStyles){ka=
k.className+" "+ea;ha=r(k,ka);F=z(k,ka,ha);aa=F.maxDelay;n=Math.max(aa,0);N=F.maxDuration;if(0===N){q();return}p.hasTransitions=0<F.transitionDuration;p.hasAnimations=0<F.animationDuration}p.applyAnimationDelay&&(aa="boolean"!==typeof f.delay&&qa(f.delay)?parseFloat(f.delay):aa,n=Math.max(aa,0),F.animationDelay=aa,ba=[na,aa+"s"],v.push(ba),k.style[ba[0]]=ba[1]);Q=1E3*n;S=1E3*N;if(f.easing){var d,m=f.easing;p.hasTransitions&&(d=T+"TimingFunction",v.push([d,m]),k.style[d]=m);p.hasAnimations&&(d=Z+"TimingFunction",
v.push([d,m]),k.style[d]=m)}F.transitionDuration&&fa.push(ta);F.animationDuration&&fa.push(ua);V=Date.now();var h=Q+1.5*S;d=V+h;var m=a.data("$$animateCss")||[],s=!0;if(m.length){var L=m[0];(s=d>L.expectedEndTime)?O.cancel(L.timer):m.push(q)}s&&(h=O(c,h,!1),m[0]={timer:h,expectedEndTime:d},m.push(q),a.data("$$animateCss",m));if(fa.length)a.on(fa.join(" "),E);f.to&&(f.cleanupStyles&&Ga(B,k,Object.keys(f.to)),Ba(a,f))}}function c(){var b=a.data("$$animateCss");if(b){for(var d=1;d<b.length;d++)b[d]();
a.removeData("$$animateCss")}}if(!y)if(k.parentNode){var d=function(a){if(wa)K&&a&&(K=!1,q());else if(K=!a,F.animationDuration)if(a=pa(k,K),K)v.push(a);else{var b=v,c=b.indexOf(a);0<=a&&b.splice(c,1)}},m=0<$&&(F.transitionDuration&&0===X.transitionDuration||F.animationDuration&&0===X.animationDuration)&&Math.max(X.animationDelay,X.transitionDelay);m?O(b,Math.floor(m*$*1E3),!1):b();P.resume=function(){d(!0)};P.pause=function(){d(!1)}}else q()}var f=c||{};f.$$prepared||(f=la(Ha(f)));var B={},k=H(a);
if(!k||!k.parentNode||!I.enabled())return m();var v=[],D=a.attr("class"),C=La(f),y,K,wa,G,P,n,Q,N,S,V,fa=[];if(0===f.duration||!s.animations&&!s.transitions)return m();var A=f.event&&ca(f.event)?f.event.join(" "):f.event,W="",U="";A&&f.structural?W=Y(A,"ng-",!0):A&&(W=A);f.addClass&&(U+=Y(f.addClass,"-add"));f.removeClass&&(U.length&&(U+=" "),U+=Y(f.removeClass,"-remove"));f.applyClassesEarly&&U.length&&u(a,f);var ea=[W,U].join(" ").trim(),ka=D+" "+ea,da=Y(ea,"-active"),D=C.to&&0<Object.keys(C.to).length;
if(!(0<(f.keyframeStyle||"").length||D||ea))return m();var ha,X;0<f.stagger?(C=parseFloat(f.stagger),X={transitionDelay:C,animationDelay:C,transitionDuration:0,animationDuration:0}):(ha=r(k,ka),X=x(k,ea,ha,Ta));f.$$skipPreparationClasses||e.addClass(a,ea);f.transitionStyle&&(C=[T,f.transitionStyle],ia(k,C),v.push(C));0<=f.duration&&(C=0<k.style[T].length,C=Ea(f.duration,C),ia(k,C),v.push(C));f.keyframeStyle&&(C=[Z,f.keyframeStyle],ia(k,C),v.push(C));var $=X?0<=f.staggerIndex?f.staggerIndex:b.count(ha):
0;(A=0===$)&&!f.skipBlocking&&ma(k,9999);var F=z(k,ka,ha),aa=F.maxDelay;n=Math.max(aa,0);N=F.maxDuration;var p={};p.hasTransitions=0<F.transitionDuration;p.hasAnimations=0<F.animationDuration;p.hasTransitionAll=p.hasTransitions&&"all"==F.transitionProperty;p.applyTransitionDuration=D&&(p.hasTransitions&&!p.hasTransitionAll||p.hasAnimations&&!p.hasTransitions);p.applyAnimationDuration=f.duration&&p.hasAnimations;p.applyTransitionDelay=qa(f.delay)&&(p.applyTransitionDuration||p.hasTransitions);p.applyAnimationDelay=
qa(f.delay)&&p.hasAnimations;p.recalculateTimingStyles=0<U.length;if(p.applyTransitionDuration||p.applyAnimationDuration)N=f.duration?parseFloat(f.duration):N,p.applyTransitionDuration&&(p.hasTransitions=!0,F.transitionDuration=N,C=0<k.style[T+"Property"].length,v.push(Ea(N,C))),p.applyAnimationDuration&&(p.hasAnimations=!0,F.animationDuration=N,v.push([va,N+"s"]));if(0===N&&!p.recalculateTimingStyles)return m();if(null!=f.delay){var ba;"boolean"!==typeof f.delay&&(ba=parseFloat(f.delay),n=Math.max(ba,
0));p.applyTransitionDelay&&v.push([ja,ba+"s"]);p.applyAnimationDelay&&v.push([na,ba+"s"])}null==f.duration&&0<F.transitionDuration&&(p.recalculateTimingStyles=p.recalculateTimingStyles||A);Q=1E3*n;S=1E3*N;f.skipBlocking||(p.blockTransition=0<F.transitionDuration,p.blockKeyframeAnimation=0<F.animationDuration&&0<X.animationDelay&&0===X.animationDuration);f.from&&(f.cleanupStyles&&Ga(B,k,Object.keys(f.from)),Aa(a,f));p.blockTransition||p.blockKeyframeAnimation?w(N):f.skipBlocking||ma(k,!1);return{$$willAnimate:!0,
end:d,start:function(){if(!y)return P={end:d,cancel:h,resume:null,pause:null},G=new l(P),J(L),G}}}}]}]).provider("$$animateCssDriver",["$$animationProvider",function(a){a.drivers.push("$$animateCssDriver");this.$get=["$animateCss","$rootScope","$$AnimateRunner","$rootElement","$sniffer","$$jqLite","$document",function(a,c,d,e,l,O,D){function s(a){return a.replace(/\bng-\S+\b/g,"")}function y(a,b){S(a)&&(a=a.split(" "));S(b)&&(b=b.split(" "));return a.filter(function(a){return-1===b.indexOf(a)}).join(" ")}
function I(c,e,v){function g(a){var b={},c=H(a).getBoundingClientRect();t(["width","height","top","left"],function(a){var d=c[a];switch(a){case "top":d+=J.scrollTop;break;case "left":d+=J.scrollLeft}b[a]=Math.floor(d)+"px"});return b}function l(){var c=s(v.attr("class")||""),d=y(c,q),c=y(q,c),d=a(h,{to:g(v),addClass:"ng-anchor-in "+d,removeClass:"ng-anchor-out "+c,delay:!0});return d.$$willAnimate?d:null}function D(){h.remove();e.removeClass("ng-animate-shim");v.removeClass("ng-animate-shim")}var h=
P(H(e).cloneNode(!0)),q=s(h.attr("class")||"");e.addClass("ng-animate-shim");v.addClass("ng-animate-shim");h.addClass("ng-anchor");z.append(h);var w;c=function(){var c=a(h,{addClass:"ng-anchor-out",delay:!0,from:g(e)});return c.$$willAnimate?c:null}();if(!c&&(w=l(),!w))return D();var m=c||w;return{start:function(){function a(){c&&c.end()}var b,c=m.start();c.done(function(){c=null;if(!w&&(w=l()))return c=w.start(),c.done(function(){c=null;D();b.complete()}),c;D();b.complete()});return b=new d({end:a,
cancel:a})}}}function r(a,b,c,e){var s=x(a,R),l=x(b,R),h=[];t(e,function(a){(a=I(c,a.out,a["in"]))&&h.push(a)});if(s||l||0!==h.length)return{start:function(){function a(){t(b,function(a){a.end()})}var b=[];s&&b.push(s.start());l&&b.push(l.start());t(h,function(a){b.push(a.start())});var c=new d({end:a,cancel:a});d.all(b,function(a){c.complete(a)});return c}}}function x(c){var d=c.element,e=c.options||{};c.structural&&(e.event=c.event,e.structural=!0,e.applyClassesEarly=!0,"leave"===c.event&&(e.onDone=
e.domOperation));e.preparationClasses&&(e.event=da(e.event,e.preparationClasses));c=a(d,e);return c.$$willAnimate?c:null}if(!l.animations&&!l.transitions)return R;var J=D[0].body;c=H(e);var z=P(c.parentNode&&11===c.parentNode.nodeType||J.contains(c)?c:J);V(O);return function(a){return a.from&&a.to?r(a.from,a.to,a.classes,a.anchors):x(a)}}]}]).provider("$$animateJs",["$animateProvider",function(a){this.$get=["$injector","$$AnimateRunner","$$jqLite",function(b,c,d){function e(c){c=ca(c)?c:c.split(" ");
for(var d=[],e={},l=0;l<c.length;l++){var t=c[l],r=a.$$registeredAnimations[t];r&&!e[t]&&(d.push(b.get(r)),e[t]=!0)}return d}var l=V(d);return function(a,b,d,y){function r(){y.domOperation();l(a,y)}function H(a,b,d,e,f){switch(d){case "animate":b=[b,e.from,e.to,f];break;case "setClass":b=[b,u,K,f];break;case "addClass":b=[b,u,f];break;case "removeClass":b=[b,K,f];break;default:b=[b,f]}b.push(e);if(a=a.apply(a,b))if(Ia(a.start)&&(a=a.start()),a instanceof c)a.done(f);else if(Ia(a))return a;return R}
function x(a,b,d,e,f){var g=[];t(e,function(e){var h=e[f];h&&g.push(function(){var e,f,g=!1,k=function(a){g||(g=!0,(f||R)(a),e.complete(!a))};e=new c({end:function(){k()},cancel:function(){k(!0)}});f=H(h,a,b,d,function(a){k(!1===a)});return e})});return g}function J(a,b,d,e,f){var g=x(a,b,d,e,f);if(0===g.length){var k,h;"beforeSetClass"===f?(k=x(a,"removeClass",d,e,"beforeRemoveClass"),h=x(a,"addClass",d,e,"beforeAddClass")):"setClass"===f&&(k=x(a,"removeClass",d,e,"removeClass"),h=x(a,"addClass",
d,e,"addClass"));k&&(g=g.concat(k));h&&(g=g.concat(h))}if(0!==g.length)return function(a){var b=[];g.length&&t(g,function(a){b.push(a())});b.length?c.all(b,a):a();return function(a){t(b,function(b){a?b.cancel():b.end()})}}}var z=!1;3===arguments.length&&ra(d)&&(y=d,d=null);y=la(y);d||(d=a.attr("class")||"",y.addClass&&(d+=" "+y.addClass),y.removeClass&&(d+=" "+y.removeClass));var u=y.addClass,K=y.removeClass,v=e(d),g,G;if(v.length){var M,h;"leave"==b?(h="leave",M="afterLeave"):(h="before"+b.charAt(0).toUpperCase()+
b.substr(1),M=b);"enter"!==b&&"move"!==b&&(g=J(a,b,y,v,h));G=J(a,b,y,v,M)}if(g||G){var q;return{$$willAnimate:!0,end:function(){q?q.end():(z=!0,r(),ga(a,y),q=new c,q.complete(!0));return q},start:function(){function b(c){z=!0;r();ga(a,y);q.complete(c)}if(q)return q;q=new c;var d,e=[];g&&e.push(function(a){d=g(a)});e.length?e.push(function(a){r();a(!0)}):r();G&&e.push(function(a){d=G(a)});q.setHost({end:function(){z||((d||R)(void 0),b(void 0))},cancel:function(){z||((d||R)(!0),b(!0))}});c.chain(e,
b);return q}}}}}]}]).provider("$$animateJsDriver",["$$animationProvider",function(a){a.drivers.push("$$animateJsDriver");this.$get=["$$animateJs","$$AnimateRunner",function(a,c){function d(c){return a(c.element,c.event,c.classes,c.options)}return function(a){if(a.from&&a.to){var b=d(a.from),r=d(a.to);if(b||r)return{start:function(){function a(){return function(){t(d,function(a){a.end()})}}var d=[];b&&d.push(b.start());r&&d.push(r.start());c.all(d,function(a){e.complete(a)});var e=new c({end:a(),cancel:a()});
