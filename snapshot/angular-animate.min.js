...
for(var b=0;b<a.length;b++){var c=a[b];if(1==c.nodeType)return c}}function Ca(a,b,c){p(b,function(b){a.addClass(b,c)})}function Da(a,b,c){p(b,function(b){a.removeClass(b,c)})}function ha(a){return function(b,c){c.addClass&&(Ca(a,b,c.addClass),c.addClass=null);c.removeClass&&(Da(a,b,c.removeClass),c.removeClass=null)}}function ia(a){a=a||{};if(!a.$$prepared){var b=a.domOperation||L;a.domOperation=function(){a.$$domOperationFired=!0;b();b=L};a.$$prepared=!0}return a}function da(a,b){ta(a,b);ua(a,b)}
function ta(a,b){b.from&&(a.css(b.from),b.from=null)}function ua(a,b){b.to&&(a.css(b.to),b.to=null)}function Q(a,b,c){var d=(b.addClass||"")+" "+(c.addClass||""),g=(b.removeClass||"")+" "+(c.removeClass||"");a=Ea(a.attr("class"),d,g);va(b,c);b.addClass=a.addClass?a.addClass:null;b.removeClass=a.removeClass?a.removeClass:null;return b}function Ea(a,b,c){function d(a){T(a)&&(a=a.split(" "));var b={};p(a,function(a){a.length&&(b[a]=!0)});return b}var g={};a=d(a);b=d(b);p(b,function(a,b){g[b]=1});c=d(c);
p(c,function(a,b){g[b]=1===g[b]?null:-1});var t={addClass:"",removeClass:""};p(g,function(b,c){var d,g;1===b?(d="addClass",g=!a[c]):-1===b&&(d="removeClass",g=a[c]);g&&(t[d].length&&(t[d]+=" "),t[d]+=c)});return t}function wa(a,b,c){var d=Object.create(null),g=a.getComputedStyle(b)||{};p(c,function(a,b){var c=g[a];if(c){var k=c.charAt(0);if("-"===k||"+"===k||0<=k)c=Fa(c);0===c&&(c=null);d[b]=c}});return d}function Fa(a){var b=0;a=a.split(/\s*,\s*/);p(a,function(a){"s"==a.charAt(a.length-1)&&(a=a.substring(0,
a.length-1));a=parseFloat(a)||0;b=b?Math.max(a,b):a});return b}function la(a){return 0===a||null!=a}function xa(a,b){var c=N,d=a+"s";b?c+="Duration":d+=" linear all";return[c,d]}function ja(a,b){var c=b?"-"+b+"s":"";ea(a,[fa,c]);return[fa,c]}function ma(a,b){var c=b?"paused":"",d=U+"PlayState";ea(a,[d,c]);return[d,c]}function ea(a,b){a.style[b[0]]=b[1]}function ya(){var a=Object.create(null);return{flush:function(){a=Object.create(null)},count:function(b){return(b=a[b])?b.total:0},get:function(b){return(b=
a[b])&&b.value},put:function(b,c){a[b]?a[b].total++:a[b]={total:1,value:c}}}}var L=s.noop,va=s.extend,I=s.element,p=s.forEach,aa=s.isArray,T=s.isString,na=s.isObject,Ga=s.isUndefined,Ha=s.isDefined,Ia=s.isFunction,Ja=s.isElement,N,oa,U,pa;H.ontransitionend===$&&H.onwebkittransitionend!==$?(N="WebkitTransition",oa="webkitTransitionEnd transitionend"):(N="transition",oa="transitionend");H.onanimationend===$&&H.onwebkitanimationend!==$?(U="WebkitAnimation",pa="webkitAnimationEnd animationend"):(U="animation",
...
l,e){ba(c,a,l,e);b.progress(c,l,e)}function d(b){za(a,n);da(a,n);n.domOperation();g.complete(!b)}a=Ba(a);var u=a[0];n=ia(n);var P=a.parent(),g=new J;if(!u)return g.end(),g;aa(n.addClass)&&(n.addClass=n.addClass.join(" "));aa(n.removeClass)&&(n.removeClass=n.removeClass.join(" "));n.from&&!na(n.from)&&(n.from=null);n.to&&!na(n.to)&&(n.to=null);var f=[u.className,n.addClass,n.removeClass].join(" ");if(!z(f))return d(),g;var p=0<=["enter","move","leave"].indexOf(R),k=!D||l.get(u),f=!k&&q.get(u)||{},
...
c=a=!1,D;b&&b.length;){c||(c=x(b,F));var d=b[0];if(1!==d.nodeType)break;var u=q.get(d)||{};e||(e=u.structural||l.get(d));if(Ga(D)||!0===D)d=b.data("$$ngAnimateChildren"),Ha(d)&&(D=d);if(e&&!1===D)break;a||(a=x(b,r));b=b.parent()}return(!e||D)&&c&&a}function E(a,b,c){c=c||{};c.state=b;a=a.length?a[0]:a;a.setAttribute("data-ng-animate",b);c=(b=q.get(a))?va(b,c):c;q.put(a,c)}var q=new k,l=new k,D=null,P=t.$watch(function(){return 0===v.totalPendingRequests},function(a){a&&(P(),t.$$postDigest(function(){t.$$postDigest(function(){null===
