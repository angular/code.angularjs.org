...
this.b.exp=this.text.substring(this.l,this.index);this.a=null}};var U=["$$messageFormat","$delegate",function(a,b){if("{{"!=b.startSymbol()||"}}"!=b.endSymbol())throw e("nochgmustache");var c=a.interpolate;c.startSymbol=b.startSymbol;c.endSymbol=b.endSymbol;return c}],m=l.module("ngMessageFormat",["ng"]);m.provider("$$messageFormat",function(){this.$get=["$parse","$locale","$sce","$exceptionHandler",function(a,b,d,f){function g(a,b,c){return function(g){try{return g=a?d.getTrusted(a,g):d.valueOf(g),
b&&void 0===g?g:C(g)}catch(h){f(e.interr(c,h))}}}return{interpolate:function(d,e,f,h){d=new c(d,0,a,b.pluralCat,g(f,h,d),e,f,h);d.Ca(d.wa);return d.d}}}]});m.config(["$provide",function(a){a.decorator("$interpolate",U)}])})(window,window.Ga);
