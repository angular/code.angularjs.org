describe("angular+jqlite", function() {
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-app", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-app");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-href", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-href");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-src", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-src");
    });
  
});

  describe("api/angular.module.ng.$compileProvider.directive.ng-disabled", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-disabled");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-checked", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-checked");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-multiple", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-multiple");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-readonly", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-readonly");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-selected", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-selected");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-form", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-form");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-bind", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-bind");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-bind-html-unsafe", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-bind-html-unsafe");
    });
  
});

  describe("api/angular.module.ng.$compileProvider.directive.ng-bind-html", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-bind-html");
    });
  
});

  describe("api/angular.module.ng.$compileProvider.directive.ng-bind-template", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-bind-template");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-bind-attr", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-bind-attr");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-class", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-class");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-class-odd", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-class-odd");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-class-even", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-class-even");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-cloak", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-cloak");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-controller", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-controller");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-click", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-click");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-dblclick", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-dblclick");
    });
  
});

  describe("api/angular.module.ng.$compileProvider.directive.ng-mousedown", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-mousedown");
    });
  
});

  describe("api/angular.module.ng.$compileProvider.directive.ng-mouseup", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-mouseup");
    });
  
});

  describe("api/angular.module.ng.$compileProvider.directive.ng-mouseover", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-mouseover");
    });
  
});

  describe("api/angular.module.ng.$compileProvider.directive.ng-mouseenter", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-mouseenter");
    });
  
});

  describe("api/angular.module.ng.$compileProvider.directive.ng-mouseleave", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-mouseleave");
    });
  
});

  describe("api/angular.module.ng.$compileProvider.directive.ng-mousemove", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-mousemove");
    });
  
});

  describe("api/angular.module.ng.$compileProvider.directive.ng-submit", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-submit");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-include", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-include");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-init", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-init");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-pluralize", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-pluralize");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-non-bindable", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-non-bindable");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-repeat", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-repeat");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-show", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-show");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-hide", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-hide");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-style", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-style");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-switch", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-switch");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-transclude", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-transclude");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-view", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-view");
    });
  ...
  describe("api/angular.module.ng.$sanitize", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ng.$sanitize");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-model.NgModelController", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-model.NgModelController");
    });
  
});

  describe("api/angular.module.ng.$compileProvider.directive.ng-model", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-model");
    });
  
});

  describe("api/angular.module.ng.$compileProvider.directive.ng-change", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-change");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-model-instant", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-model-instant");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-list", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-list");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.module.ng.$compileProvider.directive");
    });
...
describe("angular+jquery", function() {
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-app", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-app");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-href", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-href");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-src", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-src");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-disabled", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-disabled");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-checked", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-checked");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-multiple", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-multiple");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-readonly", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-readonly");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-selected", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-selected");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-form", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-form");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-bind", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-bind");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-bind-html-unsafe", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-bind-html-unsafe");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-bind-html", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-bind-html");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-bind-template", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-bind-template");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-bind-attr", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-bind-attr");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-class", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-class");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-class-odd", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-class-odd");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-class-even", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-class-even");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-cloak", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-cloak");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-controller", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-controller");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-click", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-click");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-dblclick", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-dblclick");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-mousedown", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-mousedown");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-mouseup", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-mouseup");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-mouseover", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-mouseover");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-mouseenter", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-mouseenter");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-mouseleave", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-mouseleave");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-mousemove", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-mousemove");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-submit", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-submit");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-include", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-include");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-init", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-init");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-pluralize", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-pluralize");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-non-bindable", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-non-bindable");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-repeat", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-repeat");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-show", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-show");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-hide", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-hide");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-style", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-style");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-switch", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-switch");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-transclude", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-transclude");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-view", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-view");
    });
  ...
  describe("api/angular.module.ng.$sanitize", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ng.$sanitize");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-model.NgModelController", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-model.NgModelController");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-model", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-model");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-change", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-change");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-model-instant", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-model-instant");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive.ng-list", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ng.$compileProvider.directive.ng-list");
    });
  ...
  describe("api/angular.module.ng.$compileProvider.directive", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.module.ng.$compileProvider.directive");
    });
