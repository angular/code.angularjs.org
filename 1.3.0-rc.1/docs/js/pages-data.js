...
angular.module('pagesData', [])
  ...
  "api/ng": {
    ...
    "searchTerms": {
      "titleWords": "ng",
      "keywords": "angular angularjs api application breakdown components core default directives doc-module-components essential filters function high html js js-angular-release level lists loaded module ng partials regex_string_regexp services src started table testing",
      "members": ""
    }
  },
  ...
  "api/auto": {
    ...
    "searchTerms": {
      "titleWords": "auto",
      "keywords": "$injector api auto automatically fn_args html implicit injector js js-angular-release module partials src",
      "members": ""
    }
  },
  ...
  "api/ng/function/angular.element": {
    ...
    "searchTerms": {
      ...
      "keywords": "$destroy $rootscope addclass additional alert alert-success alias allows angular angularjs api api-compatible apis append associated attached attr bind bindings built-in called calling camelcase children class clean clone commonly compatible contents controller cross-browser css current data default delegates destruction detach directive directly dom domcontentloaded domelement dummy element elements empty eq event eventdata events extras find fired fires footprint function functionality getter goal handlers hasclass html implements inheriteddata injector intercepts isolate isolatescope jqlite jquery js js-angular-release limited lite load lookups manipulate methods module namespaces needed ng ng339 ngcontroller ngmodel nodes non-isolate object original parent partials party passes prepend prop provided raw reached ready references remove removeattr removeclass removed removedata replacewith retrieved retrieves returns scope selectors simply small src starts string subset support tag text tiny toggleclass top triggerhandler unbind val walks wrap wrapped wraps",
      "members": ""
    }
  },
  "api/ng/type/angular.Module": {
    ...
    "searchTerms": {
      ...
      "keywords": "angular api configuring html interface js js-angular-release loader module modules ng partials setupmoduleloader src type",
  ...
  "api/ng/type/$cacheFactory.Cache": {
    ...
    "searchTerms": {
      ...
      "keywords": "$cachefactory $http angular api behave cache cachefactory cacheid data directive example expect factory function html info inject js js-angular-release key module ng object partials remove removeall retrieve return script size src store super-cache supercache templates test tobeundefined toequal type",
  ...
  "api/ng/service/$compile": {
    ...
    "searchTerms": {
      "titleWords": "$compile",
      "keywords": "$attrs $compile $compileminerr $compileprovider $digest $element $observe $rootscope $sce $scope $set $templatecache $transclude $watch access accessing accidentally actual add advantage alert alert-error alert-success alert-warning alias aliasing allow allowed allowing allows amount angular angularjs api app application applied apply appropriate argument arguments array assigned associated assumed async asynchronous asynchronously attach attempt attr attribute attributes attrs augment automatic automatically avoid avoided behavior behavioural bi-directional bind binding bindings bindtocontroller bound bracket call called caller calling case cases change changed changes channel child children class classes clone cloneattachfn cloned clonedelement clonelinkinfn clonelinkingfn clones collect comment common communicate communication compilation compile compiled compiler compiles compiling component components comprehensive config configuration considered console contained containers content contents context contexts continue control controller controlleras controllers correct corresponding count create created creates creating creating-custom-directives_creating-directives_template-expanding-directive ctrl current custom data data-ng-bind deals declaration declared deeply default defaults define defined defines definition deprecated derived desirable details developer difference differs directive directive-name-end directive-name-start directivedefinitionobject directivename directives document doesn dom eacm easily effects efficient element elements elm empty entire equivalent error errors evaluated example example-example5 examples exception execute executed execution exist exp expressed expression factory fail false feature flag fn form fourth fragment function functions futureparentelement gentle gettrustedresourceurl greater group guide hand handle hash hasn hello html iattrs ielement illustrate imperatively in-depth including increment infinite info inherit initial inject injectable injected inside instance instantiated instructions inter inter-communication interpolated interpolation introduction isolate isolated js js-angular-release link linked linking linkingfn list listener listeners load loaded loading local localfn localmodel localname locals locate log logic loop lower main major manipulate manual manually map markup matching math mathml maxpriority migrates modify module multielement multiple my-attr my-directive mymodule names namespace needed nested ng ng:bind ngbind ngclick nginclude ngmodel ngtransclude nodes non_assignable_model_expression normal normalized notation note null number numerical object objects observe occurs optional options order original otherinjectables outer overflow override parameter parent parentmodel parents partials pass passed passing phase place point post post-link post-linking postlink practice pre pre-bound pre-link pre-linking prefix prefixed prelink preloaded priority private process produces properties property prototypically provided raised read reason receives recomended recommended recursively red-on-hover reference referenced reflect reflected registered registering registration release relying removed replace replacement representing request require required resides resolved resp responsible restrict restricts result return returning returns reusable reverse root rule safe scenarios scope searching send service set setup share shared sibling siblingdirectivename simplified single sort source special specific src stack stalling strictly string stringalias strings style subset supports suspend suspended svg takes tattrs telement template templateelement templatenamespace templates templateurl terminal testing testing-transclusion-directives throw time top-level transclude transcluded transcludefn transcludes transclusion transformation transformations transforming tree true type typical typically undefined unspecified updated updating url usual v2 values var variable variety view wait waiting walking watches ways widget work working works wrap wrapper x-ng-bind",
      "members": ""
    }
  },
  "api/ng/provider/$compileProvider": {
    ...
    "searchTerms": {
      ...
      "keywords": "$compileprovider $inject api compile html js js-angular-release module ng partials provider src",
  ...
  "api/ng/type/$compile.directive.Attributes": {
    ...
    "searchTerms": {
      ...
      "keywords": "$compile angular api attributes binding compile current data-ng-bind directive dom element equivalent functions html js js-angular-release linking module needed ng ng-bind ng:bind nodesetlinkingfn normalization normalized object partials reflect shared src treated type values x-ng-bind",
  ...
  "api/ng/directive/a": {
    ...
    "searchTerms": {
      "titleWords": "a",
      "keywords": "action additem api attribute behavior causing change changing creation default directive easy empty href html htmlanchordirective item js js-angular-release links list location modifies module ng ng-click ngclick partials permits prevented reloads src tag",
      "members": ""
    }
  },
  ...
  "api/ng/directive/ngSrc": {
    ...
    "searchTerms": {
      ...
      "keywords": "angular api attribute attrs browser buggy correct directive doesn expression fetch gravatar html http img inside js js-angular-release literal markup module ng ng-src ngattributealiasdirectives ngsrc partials problem replaces solves src string text url work write",
      "members": ""
    }
  },
  "api/ng/directive/ngSrcset": {
    ...
    "searchTerms": {
      ...
      "keywords": "angular api attribute attrs browser buggy correct directive doesn expression fetch gravatar html http img inside js js-angular-release literal markup module ng ng-srcset ngattributealiasdirectives ngsrcset partials problem replaces solves src srcset string text url work write",
      "members": ""
    }
  },
  "api/ng/directive/ngDisabled": {
    ...
    "searchTerms": {
      ...
      "keywords": "absence angular api attribute attributes attrs binding boolean browser browsers button chrome complementary directive disabled element enabled example-example7 expression false guide html ie8 ies input interpolation isdisabled js js-angular-release lost module ng ng-init ngattributealiasdirectives ngdisabled older partials permanent place presence preserve problem reliable removed removes require scope set shouldn solves special specification src store true truthy values",
      "members": ""
    }
  },
  ...
  "api/ng/type/form.FormController": {
    ...
    "searchTerms": {
      ...
      "keywords": "$dirty $error $inject $invalid $pristine $submitted $valid api arrays built-in control controls creates directive dirty email error failing form formcontroller forms hash html instance interacted invalid js js-angular-release max maxlength min minlength module names nested ng number object partials pattern references required src submitted tokens track true type url user valid validation validator validators values",
      "members": "$addcontrol $commitviewvalue $dirty $error $invalid $pristine $removecontrol $rollbackviewvalue $setdirty $setpristine $setsubmitted $setvalidity $submitted $valid"
    }
  },
  "api/ng/directive/ngForm": {
    ...
    "searchTerms": {
      ...
      "keywords": "alias allow api capabilities controller controls determined directive eac elements example form formdirectivefactory forms group html js js-angular-release module nest nestable nesting ng ngform note partials posting published purpose replacement scope server src sub-group tag validity",
      "members": ""
    }
  },
  ...
  "api/ng/input/input[text]": {
    ...
    "searchTerms": {
      ...
      "keywords": "adds angular api assignable attribute automatically binding changes constraint control controls data data-bind defined element elements entered error evaluates example-text-input-directive executed expected expression expressions false feature form html ignored inherited inline input interaction js js-angular-release key longer match maxlength minlength module ng ngchange ngmaxlength ngminlength ngmodel ngpattern ngrequired offered parameter partials pattern patterns property published regexp required scope set sets shorter src standard text textinputtype trim true types user validation",
      "members": ""
    }
  },
  "api/ng/input/input[date]": {
    ...
    "searchTerms": {
      ...
      "keywords": "adds angular api assignable attribute browser browsers case changes constraint control createdateinputtype cues data-bind default defined directive element entered error evaluates example example-date-input-directive executed expected expression form format greater html html5 input instance interaction iso iso-8601 js js-angular-release key label max min model modern module ng ngchange ngmodel ngmodeloptions ngrequired object partials placeholder property provide published read required sets src string support text timezone transformation true type user users valid validation",
      "members": ""
    }
  },
  "api/ng/input/input[dateTimeLocal]": {
    ...
    "searchTerms": {
      ...
      "keywords": "adds angular api assignable attribute browser browsers case changes constraint control createdateinputtype data-bind datetime datetimelocal default defined directive element entered error evaluates example example-datetimelocal-input-directive executed expression form format greater html html5 input instance interaction iso iso-8601 js js-angular-release key local max min model module ng ngchange ngmodel ngmodeloptions ngrequired object partials property published read required sets src support text timezone transformation true user valid validation",
      "members": ""
    }
  },
  "api/ng/input/input[time]": {
    ...
    "searchTerms": {
      ...
      "keywords": "adds angular api assignable attribute binding browser browsers case changes constraint control createdateinputtype data-bind default defined directive element entered error evaluates example example-time-input-directive executed expression form format greater hh html html5 input instance interaction iso iso-8601 january js js-angular-release key local max min mm model module ng ngchange ngmodel ngmodeloptions ngrequired object output partials property published read required sets src ss support text time timezone transformation true user valid validation",
      "members": ""
    }
  },
  "api/ng/input/input[week]": {
    ...
    "searchTerms": {
      ...
      "keywords": "adds angular api assignable attribute browser browsers case changes constraint control createdateinputtype data-bind default defined directive element entered error evaluates example example-week-input-directive executed expression form format greater html html5 input instance interaction iso iso-8601 js js-angular-release key max min model module ng ngchange ngmodel ngmodeloptions ngrequired object partials property published read required sets src support text timezone transformation true user valid validation week week-of-the-year",
      "members": ""
    }
  },
  "api/ng/input/input[month]": {
    ...
    "searchTerms": {
      ...
      "keywords": "adds angular api assignable assumed attribute browser browsers case changes constraint control createdateinputtype data-bind default defined directive element entered error evaluates event example example-month-input-directive executed expression form format greater html html5 input instance interaction iso iso-8601 js js-angular-release key max min model module month ng ngchange ngmodel ngmodeloptions ngrequired object partials property published read required set sets src support text timezone transformation true user valid validation",
      "members": ""
    }
  },
  ...
  "api/ng/input/input[radio]": {
    ...
    "searchTerms": {
      ...
      "keywords": "angular api assignable button changes control data-bind element example-radio-input-directive executed expression form html input interaction js js-angular-release module ng ngchange ngmodel ngvalue partials property published radio radioinputtype selected set sets src user",
      "members": ""
    }
  },
  "api/ng/input/input[checkbox]": {
    ...
    "searchTerms": {
      ...
      "keywords": "angular api assignable changes checkbox checkboxinputtype control data-bind element example-checkbox-input-directive executed expression form html input interaction js js-angular-release module ng ngchange ngfalsevalue ngmodel ngtruevalue partials property published selected set src user",
      "members": ""
    }
  },
  ...
  "api/ng/directive/input": {
    ...
    "searchTerms": {
      "titleWords": "input",
      "keywords": "angular api assignable attribute automatically behavior browsers changes control controls data-bind data-binding defined directive element entered error example-input-directive executed expected expression expressions false feature form html html5 ignored inline input inputdirective interaction js js-angular-release key longer match maxlength minlength module ng ngchange ngmaxlength ngminlength ngmodel ngpattern ngrequired offered older parameter partials pattern patterns polyfills property published regexp required scope set sets shorter src trim true types user validation",
      "members": ""
    }
  },
  "api/ng/type/ngModel.NgModelController": {
    ...
    "searchTerms": {
      ...
      "keywords": "$asyncvalidators $dirty $error $formatters $http $invalid $modelvalue $parsers $pending $pristine $q $sanitize $sce $setvalidity $touched $untouched $valid $validators $viewchangelisteners $viewvalue $watches achieve actual additional api applied argument arguments array asynchronous attribute automatically bad bound browser browsers called changed changes code collaborate collection content contenteditable contents control controller convert css custom data-binding deals decide delivered depending desired directive directives display dom edited element error event events example example-ngmodelcontroller execute exist exists expected failing fails false focus format formatter formatting fulfill fulfilled function functions hash html html5 http ids ignored include inline input interacted invalid js js-angular-release key level listener listening logic lookup lost marks mind model modelvalue module ng ng-model ngmodel ngmodelcontroller ngsanitize note notice object older onclick operation order parallel parsers parsing partials passed passes passing pending perform pipeline place populate process promise provide provided purposefully push reads refers reject rejected remove rendering request required resolved response result return returns sanitize server service services set src status string success synchronous tells test touppercase triggered true turn type undefined uniqueusername unsafe update updated updates user username validation validationfn validations validator validators validcharacters validity values var view viewvalue work",
      "members": "$asyncvalidators $commitviewvalue $dirty $error $formatters $invalid $isempty $modelvalue $parsers $pending $pristine $render $rollbackviewvalue $setpristine $settouched $setuntouched $setvalidity $setviewvalue $touched $untouched $valid $validate $validators $viewchangelisteners $viewvalue"
    }
  },
  ...
  "api/ng/directive/ngChange": {
    ...
    "searchTerms": {
      ...
      "keywords": "$parsers api change changed changes committed continued directive element evaluate evaluated event example-ngchange-directive expression form guide html input invalid javascript js js-angular-release key leaves model module ng ngchange ngchangedirective ngmodel note null onchange partials pipeline presses programmatically requires return returned src stay transformation triggers user",
      "members": ""
    }
  },
  "api/ng/directive/ngList": {
    ...
    "searchTerms": {
      ...
      "keywords": "allows api array attribute behaviour character comma converts custom dealing default delimited delimiter directive equivalent example example-nglist-directive example-nglist-directive-newlines false html ignored implies input item items joining js js-angular-release list model module newline ng ng-list nglist nglistdirective ngtrim optional partials respected responsible separator set space split splitting src string strings stripped tab text user validation whitespace",
      "members": ""
    }
  },
  "api/ng/directive/ngValue": {
    ...
    "searchTerms": {
      ...
      "keywords": "angular api attribute binds bound buttons directive dynamically element example-ngvalue-directive expression generating html input js js-angular-release lists module ng ng-repeat ngmodel ngvalue ngvaluedirective partials radio selected set src",
      "members": ""
    }
  },
  "api/ng/directive/ngModelOptions": {
    ...
    "searchTerms": {
      ...
      "keywords": "$rollbackviewvalue access action actual allowinvalid allows api apply attribute behavior belonging bind blur boolean bound browser button called canceled change changes clear control controllers correctly current custom debounce debounced debouncing default defines delay delimited determines directive displayed easiest empty enclosing escape event events example example-ngmodeloptions-directive-blur example-ngmodeloptions-directive-debounce example-ngmodeloptions-directive-getter-setter expires field fields focus focused form functions getter getters gettersetter html indicates input inputs inside instance integer invoke js js-angular-release key list loses making matches method milliseconds model module nature ng ng-model-options ngclick ngmodel ngmodelcontroller ngmodeloptions ngmodeloptionsdirective ngsubmit note object occur options order override partials pending place pressed published read reference relevant reset scope set setting space special src string submit submitted supplied supported synchronized takes time timer timezone treat trigger triggers tuning type undefined update updated updateon updates utc valid validate values view",
      "members": ""
    }
  },
  ...
  "api/ng/directive/ngBindTemplate": {
    ...
    "searchTerms": {
      ...
      "keywords": "api attribute box change content directive element elements enter eval example-example15 expressions form greeting html interpolation js js-angular-release module multiple needed ng ngbind ngbindtemplate ngbindtemplatedirective option partials replaced span specifies src template text title watch",
      "members": ""
    }
  },
  "api/ng/directive/ngBindHtml": {
    ...
    "searchTerms": {
      ...
      "keywords": "$sanitize $sce angular api bind binding bound bypass content contextual core creates current default dependencies directive element ensure escaping evaluate evaluating example example-example16 exception explicitly exploit expression functionality guide html including innerhtml innerhtml-ed isn js js-angular-release module ng ngbind ngbindhtml ngbindhtmldirective ngsanitize note partials result safe sanitization sanitized secure service src strict trustashtml trusted unavailable utilize values",
      "members": ""
    }
  },
  ...
  "api/ng/directive/ngClassOdd": {
    ...
    "searchTerms": {
      ...
      "keywords": "ac api applied array class conjunction delimited directive directives eval evaluation exactly example-example19 expression guide html js js-angular-release module names ng ngclass ngclasseven ngclassodd ngclassodddirective ngrepeat odd partials representing result rows scope space src string work",
      "members": ""
    }
  },
  "api/ng/directive/ngClassEven": {
    ...
    "searchTerms": {
      ...
      "keywords": "ac api applied array class conjunction delimited directive directives eval evaluation exactly example-example20 expression guide html js js-angular-release module names ng ngclass ngclasseven ngclassevendirective ngclassodd ngrepeat odd partials representing result rows scope space src string work",
      "members": ""
    }
  },
  ...
  "api/ng/directive/ngController": {
    ...
    "searchTerms": {
      ...
      "keywords": "$controllerprovider $route $scope access accessed accessible accessing adding advantages allowglobals angular api appear application apply aspect attach attached attaches automatically avoiding binding bindings binds boilerplates business called changes class classes clearing code common community components configured contact controller controllers current data declaration declare declared declaring decorate definition demonstrates design directive directly dom don easier easily editing element evaluates example example-ngcontroller example-ngcontrolleras executed expression form function functions generally globally globals greeting guide html included inheritance injects inside instance js js-angular-release key logic manual markup masking methods mistake model model-view-controller models module multiple mvc ng ng-controller ngcontroller ngcontrollerdirective ngroute note obvious option partials pattern primitives principles properties property propertyname prototypal published recommended reflected registered removing rendered route scope scopes second service settings settingscontroller1 settingscontroller2 simple source specifies src style styles supports syntax tab template update user values view worry writing",
      "members": ""
    }
  },
  ...
  "api/ng/directive/ngClick": {
    ...
    "searchTerms": {
      ...
      "keywords": "$event allows api behavior click clicked custom directive element evaluate event example-example22 expression guide html js js-angular-release module ng ngclick ngeventdirectives ngeventdirs object partials src",
      "members": ""
    }
  },
  "api/ng/directive/ngDblclick": {
    ...
    "searchTerms": {
      ...
      "keywords": "$event allows api behavior custom dblclick directive evaluate event example-example23 expression guide html js js-angular-release module ng ngdblclick ngeventdirs object partials src",
      "members": ""
    }
  },
  "api/ng/directive/ngMousedown": {
    ...
    "searchTerms": {
      ...
      "keywords": "$event allows api behavior custom directive evaluate event example-example24 expression guide html js js-angular-release module mousedown ng ngeventdirs ngmousedown object partials src",
      "members": ""
    }
  },
  "api/ng/directive/ngMouseup": {
    ...
    "searchTerms": {
      ...
      "keywords": "$event api behavior custom directive evaluate event example-example25 expression guide html js js-angular-release module mouseup ng ngeventdirs ngmouseup object partials src",
      "members": ""
    }
  },
  "api/ng/directive/ngMouseover": {
    ...
    "searchTerms": {
      ...
      "keywords": "$event api behavior custom directive evaluate event example-example26 expression guide html js js-angular-release module mouseover ng ngeventdirs ngmouseover object partials src",
      "members": ""
    }
  },
  "api/ng/directive/ngMouseenter": {
    ...
    "searchTerms": {
      ...
      "keywords": "$event api behavior custom directive evaluate event example-example27 expression guide html js js-angular-release module mouseenter ng ngeventdirs ngmouseenter object partials src",
      "members": ""
    }
  },
  "api/ng/directive/ngMouseleave": {
    ...
    "searchTerms": {
      ...
      "keywords": "$event api behavior custom directive evaluate event example-example28 expression guide html js js-angular-release module mouseleave ng ngeventdirs ngmouseleave object partials src",
      "members": ""
    }
  },
  "api/ng/directive/ngMousemove": {
    ...
    "searchTerms": {
      ...
      "keywords": "$event api behavior custom directive evaluate event example-example29 expression guide html js js-angular-release module mousemove ng ngeventdirs ngmousemove object partials src",
      "members": ""
    }
  },
  "api/ng/directive/ngKeydown": {
    ...
    "searchTerms": {
      ...
      "keywords": "$event altkey api behavior custom directive evaluate event example-example30 expression guide html interrogated js js-angular-release keycode keydown module ng ngeventdirs ngkeydown object partials src",
      "members": ""
    }
  },
  "api/ng/directive/ngKeyup": {
    ...
    "searchTerms": {
      ...
      "keywords": "$event altkey api behavior custom directive evaluate event example-example31 expression guide html interrogated js js-angular-release keycode keyup module ng ngeventdirs ngkeyup object partials src",
      "members": ""
    }
  },
  "api/ng/directive/ngKeypress": {
    ...
    "searchTerms": {
      ...
      "keywords": "$event altkey api behavior custom directive evaluate event example-example32 expression guide html interrogated js js-angular-release keycode keypress module ng ngeventdirs ngkeypress object partials src",
      "members": ""
    }
  },
  "api/ng/directive/ngSubmit": {
    ...
    "searchTerms": {
      ...
      "keywords": "$event action additionally alert alert-warning angular api attributes binding careful class current data-action default detailed directive discussion documentation double-submission enables eval event events example-example33 expression expressions form guide handlers html js js-angular-release module ng ngclick ngeventdirs ngsubmit object onsubmit partials prevents reloading request sending server src submitting-a-form-and-preventing-the-default-action triggered x-action",
      "members": ""
    }
  },
  "api/ng/directive/ngFocus": {
    ...
    "searchTerms": {
      ...
      "keywords": "$apply $evalasync $event angularjs api behavior calling consistent custom directive ensure evaluate event executed executes expression fired focus guide html input js js-angular-release module ng ngclick ngeventdirs ngfocus note object partials scope select src synchronously textarea window",
      "members": ""
    }
  },
  "api/ng/directive/ngBlur": {
    ...
    "searchTerms": {
      ...
      "keywords": "$apply $evalasync $event angularjs api behavior blur consistent custom directive dom element ensure evaluate event executed executes expression fired fires focus focussed guide html input js js-angular-release lost manipulations module mozilla ng ngblur ngclick ngeventdirs note object org partials removing scope select src synchronously textarea window",
      "members": ""
    }
  },
  "api/ng/directive/ngCopy": {
    ...
    "searchTerms": {
      ...
      "keywords": "$event api behavior copy custom directive evaluate event example-example34 expression guide html input js js-angular-release module ng ngcopy ngeventdirs object partials select src textarea window",
      "members": ""
    }
  },
  "api/ng/directive/ngCut": {
    ...
    "searchTerms": {
      ...
      "keywords": "$event api behavior custom cut directive evaluate event example-example35 expression guide html input js js-angular-release module ng ngcut ngeventdirs object partials select src textarea window",
      "members": ""
    }
  },
  "api/ng/directive/ngPaste": {
    ...
    "searchTerms": {
      ...
      "keywords": "$event api behavior custom directive evaluate event example-example36 expression guide html input js js-angular-release module ng ngeventdirs ngpaste object partials paste select src textarea window",
      "members": ""
    }
  },
  ...
  "api/ng/directive/ngRepeat": {
    ...
    "searchTerms": {
      ...
      "keywords": "$even $first $id $index $last $middle $odd active adam adjacent age album albums alias alias_expression aliases amalie angularjs api applied apply array artist assign associate associated associates body boolean built case causing class code collection conjunction considered contents corresponding creating current currently custom database defined defining details directive directives display distinct dom element elements empty enter enumerate equivalent error evaluate example example-example42 explicit exposed expression extending false feature filter filtered filters flavors footer formats fragment function header html identifiers identity implies including indicating initializes input instance instantiates intermediate item items iterator js js-angular-release key leave length-1 list local long loop mapped matter message module move moving names nesting ng ng-repeat ng-repeat-end ng-repeat-start nginit ngrepeat ngrepeatdirective ngrepeats number object objects odd offset optional output parent partials pattern person points position processed properties property provide provided range removed render reorder reordered repeat repeated repeater resolve result revealed scope series set special src start store support supported supports syntax tag template track tracking tracking_expression true type typical typically unique user variable works",
      "members": ""
    }
  },
  ...
  "api/ng/directive/ngStyle": {
    ...
    "searchTerms": {
      ...
      "keywords": "ac allows api background-color conditionally corresponding css directive element evals example example-example45 expression guide html js js-angular-release module names ng ngstyle ngstyledirective object partials quoted set src style valid values",
      "members": ""
    }
  },
  ...
  "api/ng/directive/ngTransclude": {
    ...
    "searchTerms": {
      ...
      "keywords": "api content directive dom eac element example-example47 existing html inserted insertion js js-angular-release marks module nearest ng ngtransclude ngtranscludedirective parent partials point removed src transcluded transclusion",
      "members": ""
    }
  },
  "api/ng/directive/script": {
    ...
    "searchTerms": {
      "titleWords": "script",
      "keywords": "$templatecache api assigned cache content directive directives element example-example48 guide html js js-angular-release load module ng nginclude ngroute ngview partials script scriptdirective set src template templateurl text type",
      "members": ""
    }
  },
  ...
  "api/ng/service/$document": {
    ...
    "searchTerms": {
      "titleWords": "$document",
      "keywords": "$document $documentprovider $window angular api browser document element example-example50 html jqlite jquery js js-angular-release module ng object partials service src window wrapper",
      "members": ""
    }
  },
  "api/ng/service/$exceptionHandler": {
    ...
    "searchTerms": {
      ...
      "keywords": "$exceptionhandler $exceptionhandlerprovider $log action aids angular angular-mocks api associated browser console context default delegated delegates error example exception exceptionhandler exceptionoverride exceptions expressions factory fail function happen hard html implementation js js-angular-release loaded logging logs message mock module ng ngmock normal optional overridden override partials return service simply src testing tests throw thrown uncaught unit",
      "members": ""
    }
  },
  ...
  "api/ng/service/$filter": {
    ...
    "searchTerms": {
      "titleWords": "$filter",
      "keywords": "$filter $inject api data displayed example- expression filter filter_name filters formatting function general html js js-angular-release module ng partials retrieve service src syntax templates user",
      "members": ""
    }
  },
  ...
  "api/ng/filter/currency": {
    ...
    "searchTerms": {
      "titleWords": "currency",
      "keywords": "$1 $inject amount api currency current default displayed example-example52 filter filters formats formatted function html identifier input js js-angular-release locale module ng number partials provided src symbol",
      "members": ""
    }
  },
  ...
  "api/ng/filter/date": {
    ...
    "searchTerms": {
      "titleWords": "date",
      "keywords": "$inject ad api based browser clock composed considered datetime day dd description digit eee eeee elements en_us equivalent escape escaped example-example54 filter filters format formats formatted formatting friday fulldate function guide hh hour html input iso iso-8601 js js-angular-release literal local locale localizable longdate marker medium mediumdate mediumtime millisecond milliseconds minute mm mmm mmmm module month morning ng number object offset order output padded partials pm predefined quote quotes recognized representation requested rules second sep september sequence short shortdate shorter shorttime single src ss sss sssz string supported surrounding time timezone utc values versions week ww year yy yyyy yyyy-mm-dd yyyy-mm-ddthh yyyymmddthhmmssz",
      "members": ""
    }
  },
  "api/ng/filter/json": {
    ...
    "searchTerms": {
      "titleWords": "json",
      "keywords": "allows api arrays automatically binding convert converted curly debugging double example-example55 filter filters function html javascript js js-angular-release json jsonfilter module ng notation object partials primitive src string types",
      "members": ""
    }
  },
  "api/ng/filter/lowercase": {
    ...
    "searchTerms": {
      ...
      "keywords": "angular api converts filter filters function html js js-angular-release lowercase lowercasefilter module ng partials src string",
      "members": ""
    }
  },
  "api/ng/filter/uppercase": {
    ...
    "searchTerms": {
      ...
      "keywords": "angular api converts filter filters function html js js-angular-release module ng partials src string uppercase uppercasefilter",
      "members": ""
    }
  },
  "api/ng/filter/limitTo": {
    ...
    "searchTerms": {
      "titleWords": "limitTo",
      "keywords": "api array copied creates elements example-example56 exceeds filter function html input items js js-angular-release length limit limited limitto limittofilter module negative ng number partials positive returned sign source src string sub-array substring trimmed",
      "members": ""
    }
  },
  "api/ng/filter/orderBy": {
    ...
    "searchTerms": {
      "titleWords": "orderBy",
      "keywords": "$filter $inject alphabetically angular api array ascending call called calling characters comparator compare comparisons constant control copy correctly descending desired determine elements equivalent example example-example57 example-example58 expression filter function getter html injecting interpreted items js js-angular-release manually module ng note notice numbers numerically object operator optionally order orderby ordered orders parameters partials predicate predicates prefixed property result retrieving returned reverse routine saved sort sorted sorting source special src string strings substr",
      "members": ""
    }
  },
  "api/ng/provider/$httpProvider": {
    ...
    "searchTerms": {
      ...
      "keywords": "$http $httpprovider api behavior change default html http js js-angular-release module ng partials provider service src",
      "members": "defaults useapplyasync"
    }
  },
  "api/ng/service/$http": {
    "docType": "service",
    ...
    "searchTerms": {
      "titleWords": "$http",
      "keywords": "$cachefactory $http $httpbackend $httpprovider $injector $provide $q $resource $rootscope abort absolute abstraction accept accessing add adding addition address advanced advantage allows alternatively angular anonymous api apis append appendtransform application applications applied argument arguments array aspx assured asynchronous asynchronously attack augment authentication authorization automatically backend based basic body browser built cache cached caching call callback callbacks called calling chain change changing check client code common communication complete concat conditions config config-time configuration configured consider considerations considered content-type cookie cooperate cooperation core counter create creating credentials cross cross-domain currently custom data debugging default defaults deferred delete delivery demonstrates dependencies dependency1 dependency2 describing deserialize deserialized designing desirable destructured details detected digest directly doesn domain dotransform eliminate enable enabled error example example-example59 expectget expose exposed facilitates factories factory fails false familiarize fashion flag flush follow forgery format free fulfill fulfilled fully function functions gain general generate getter global globally guarantee guarantees handed handling head header headers headersgetter higher html http include info initiated injected instance intercept interceptor interceptors isarray issues javascript js js-angular-release json jsonified jsonp key kind kinds level leverage list local lowercased making map matches matter meaning meant mechanism message method methods milliseconds mock modify modifying module mozilla multiple my-header myhttpinterceptor ng ngmock ngresource note null object objects occurs optional order org override overrides overriding overriding-the-default-transformations-per-request overwrite overwritten parser partials party passed passing patch patterns pending pendingrequests per-request performing populate populated post postprocessing pre-configured pre-processing prefix prevent previous private processed processing promise properties properties_defaults property protection provide provider purposes push read readable reads real receive recommend redirect register registered reject rejection relative remaining remote remove replace replacing representation representing request requested requesterror requests requests_with_credentials require required resolved resource response responseerror responseornewpromise responses responsetype result return returned returns run-time running runs runtime security send sending serialize serialized served server servers service session set sets setting shortcut signature simple simply single site specific src standard start status stores strategies string strings strip subsequent succeeds success supply synchronous takes technique testing tests text third threats threw time timeout token tokens trained transform transformation transformations transformed transforming transformrequest transformresponse transparently true turn turned type unauthorized understand unique unit unshift updating url usage user verifiable verify version vulnerability vulnerable web website wikipedia withcredentials work writing x-xsrf-token xhr xmlhttprequest xsrf xsrf-token xsrfcookiename xsrfheadername ymvlcdpib29w",
  ...
  "api/ng/service/$httpBackend": {
    ...
    "searchTerms": {
      ...
      "keywords": "$document $http $httpbackend $httpbackendprovider $resource $window abstractions api backend browser deals delegates directly higher-level html http httpbackend implementation incompatibilities js js-angular-release jsonp mock module ng ngmock ngresource object partials responses service src swapped testing trained xmlhttprequest",
      "members": ""
    }
  },
  ...
  "api/ng/service/$locale": {
    ...
    "searchTerms": {
      "titleWords": "$locale",
      "keywords": "$locale $localeprovider angular api components en-us formatted html js js-angular-release languageid-countryid locale localization module ng partials public rules service src",
      "members": ""
    }
  },
  ...
  "api/ng/service/$log": {
    ...
    "searchTerms": {
      "titleWords": "$log",
      "keywords": "$log $logprovider $window api browser change console debug debugenabled debugging default example-example63 html implementation js js-angular-release log logging main message messages module ng partials purpose safely service simple simplify src troubleshooting writes",
  ...
  "api/ng/service/$q": {
    ...
    "searchTerms": {
      "titleWords": "$q",
      "keywords": "$apply $http $q $qprovider $rootscope access action additionally alert allow allowed allows android angular api apis approach appropriate argument associated assume async asyncgreet asynchronous asynchronously avoiding browser bytes callback callbacks called calling calls catch chain chaining chains clean-up code common commonjs commonjs-style compatible completes completion complexity composition constructed constructor-style cost create created current currently dealing defer deferred degree derived describes differences documentation documented easily equivalent error errorcallback es3 es6 es6-style essentially example execution expect expose extra failed failure fashions faster features final finally finished flickering fulfillment function functionality functions greet greeting guarantees handle handling hard harmony hello hood html https ie8 implement implementation implementations incremented indication inject injected inspired instance integrated interacting interceptors interested interface invoke javascript joining jquery js js-angular-release keywords kowal kris length lexical ll main md mechanism method methods model models modifying module mozilla multiple names native needed newly ng note notification notifies notify notifycallback object observation observe obvious oktogreet operation org parallel parameter partials parties passed pause payoff perform performed perspective point pollagain polledvalue pollstatus powerful programming progress promise promisea promiseb promisefinallycallback promises propagate propagation property proposal provide purpose reason reject rejected rejecting rejection rejects release repaints represents resembles reserved resolution resolve resolved resolvedvalue resolver resolves resolving resources response responsible result retrieved return returns robin scope second serial service setinterval settimeout shorthand signaling simulate single specification src status streamlined style success successcallback successful supported supporting synchronous synchronously takes task tasks testing throw time times tiny tobeundefined toequal traditional trouble ui unnecessary unsuccessful update updates usage var variables wikipedia word worth",
  ...
  "api/ng/service/$rootScope": {
    ...
    "searchTerms": {
      ...
      "keywords": "$rootscope $rootscopeprovider api application changes descendant developer emission event facility guide html js js-angular-release mechanism model module ng partials provide root rootscope scope scopes separation service single src subscription view watching",
      "members": ""
    }
  },
  ...
  "api/ng/service/$templateRequest": {
    "docType": "service",
    "id": "module:ng.service:$templateRequest",
    "name": "$templateRequest",
    "area": "api",
    "outputPath": "partials/api/ng/service/$templateRequest.html",
    "path": "api/ng/service/$templateRequest",
    "searchTerms": {
      "titleWords": "$templateRequest",
      "keywords": "$compile $http $templatecache $templaterequest $templaterequestprovider amount api contents data downloaded downloads empty error exception fails function html http ignore ignorerequesterror inside js js-angular-release module ng parameter partials pending promise provided request requests response service setting src stores success template templaterequest thrown thwarted total totalpendingrequests tpl true url",
  ...
  "api/ngAnimate": {
    ...
    "searchTerms": {
      ...
      "keywords": "$animate $http $timeout accidental action active add addclass addition advantage aid allow allowed allows angular angular-animate angularjs animate animated animation animation-triggering animations apart api application applied apply appropriate attached attaching attempting attribute automatically avoid base based beforeaddclass beforeremoveclass block blocking bootstrap bootstrapped break breakdown browser browsers call callback callbacks called calls cancel cancelled case caused changes child children class class-based classes classname code coding collection combine compared compatible complete completed complex config conflicts container core correct created creating css css-defined css-like css-specificity css3 currently curtain-like custom cut cycles data dealing decorates default define defined delay demonstrates designed detailed detect determine developer digest directive directives disable distinction doc-module-components doesn dom duration earlier element elements enable enabling ends ensure enter enter_sequence event events example executed existing expected explained explode-animation expression extend fade fade-add fade-add-active fade-animation false feature figure final find fired firing fits flavors force form frenzy function functionality functions future handle hooks html http ie10 incase inheritance inside instantly invalid issue issued javascript javascript-defined js js-angular-release keyframe kids layout leave length linear load long markup match matching mind mix modern module move multiple mutation my-animation my-crazy-animation mymodule naming natural ng ng-animate-children ng-enter ng-enter-active ng-enter-stagger ng-hide ng-if ng-inactive ng-include ng-leave ng-leave-active ng-move ng-view nganimate ngclass nghide ngif nginclude ngmessage ngmessages ngmodel ngmodule ngrepeat ngroute ngshow ngswitch ngview non-nganimate normal object offer opacity operating operation order outbound overly overridden parent partials passed perform performed place placing play pre-existing preparation prepares pristine properly property provided refer register remember remote remove removeclass removed render rendered rendering requests required reset restrictions return returned reveal-animation routing running safari screen selector selectors service set setclass setup simple single slide slide-animation slight special src stagger staggering standard start starting starts structural structure style styles stylesheet styling successive support supported supporting supports surrounding system tag temporarily terminal text time timing transition transition-delay transition-duration transitions trigger triggered triggering triggers true type unable unnecessary usage usage_animations valid validations values var versions view-container visiting wait work workaround works yourapp",
      "members": ""
    }
  },
  "api/ngAnimate/provider/$animateProvider": {
    ...
    "searchTerms": {
      "titleWords": "$animateProvider",
      "keywords": "$animate $animateprovider allows animate animation animations api application developers directly event find handlers html inside installed javascript js js-angular-release learn match module nganimate nganimatechildren overview partials provided provider query register requires service src triggered visit",
      "members": ""
    }
  },
  "api/ngAnimate/service/$animate": {
    ...
    "searchTerms": {
      "titleWords": "$animate",
      "keywords": "$animate $animateprovider $apply $location $scope addclass angular-specific angularjs animate animation animations api application box call callback called calling cancel cancellation cancelled changing classes click code complete completed configuration container css css-defined defined detection directives disabled dom element enter examine executed extra function general html installed javascript-defined js js-angular-release lazy learn leave location method methods mind module move nature nganimate note object operation operations overview partials path performing pre-existing promise promises provided provider removeclass requires resolve resolved return returned scenes scope service skipped src started super-long-animation support unique var visit wait work wrap",
      "members": "addclass cancel enabled enter leave move removeclass setclass"
    }
  },
  "api/ngCookies": {
    "docType": "module",
    ...
    "searchTerms": {
      ...
      "keywords": "$cookies $cookiestore angular-cookies api browser convenient cookies doc-module-components factory html js js-angular-release module ngcookies partials reading src usage wrapper writing",
      "members": ""
    }
  },
  "api/ngCookies/service/$cookies": {
    ...
    "searchTerms": {
      "titleWords": "$cookies",
      "keywords": "$cookies $eval access adding angular api browser controller cookie cookies cookiesexample created current examplecontroller exposed favoritecookie function html installed js js-angular-release module myfavorite ngcookies oatmeal object partials properties read removing requires retrieving service setting simple src strings var",
      "members": ""
    }
  },
  "api/ngCookies/service/$cookieStore": {
    ...
    "searchTerms": {
      ...
      "keywords": "$cookies $cookiestore angular api automatically backed controller cookie cookies cookiestoreexample deserialized examplecontroller favoritecookie function html installed js js-angular-release key-value module myfavorite ngcookies oatmeal objects partials remove removing requires retrieved serialized service session src storage tojson var",
  ...
  "api/ngMessages/directive/ngMessages": {
    ...
    "searchTerms": {
      "titleWords": "ngMessages messages",
      "keywords": "$error ae angular api attribute based changed click compliments container default depending depends designed directive directives displayed element error errors evaluating example-ngmessages-directive expression hide html included inserted instance internal js js-angular-release key keyvalue1 keyvalue2 keyvalue3 learn listens manages message messages module ng-message ng-messages ng-messages-multiple ngmessage ngmessages ngmessagesinclude ngmessagesmultiple ngmodel object overridden partials prioritization promote remote reporting reuseability set src stores template time true typically validation",
      "members": ""
    }
  },
  "api/ngMessages/directive/ngMessage": {
    ...
    "searchTerms": {
      ...
      "keywords": "ae api attribute based click corresponding determines directive directives dom element expression hide html js js-angular-release key keyvalue1 keyvalue2 keyvalue3 learn listens map message messages module ng-message ng-messages ngmessage ngmessages operate parent partials provided purpose situated src string visible",
      "members": ""
    }
  },
  ...
  "api/ngMock/service/$log": {
    ...
    "searchTerms": {
      "titleWords": "$log",
      "keywords": "$log $logprovider angular-mocks api array arrays error exposed function gathers html implementation js js-angular-release level level-specific log logged logging logs messages mock module ng ngmock partials property service src",
  ...
  "api/ngMock/service/$timeout": {
    ...
    "searchTerms": {
      "titleWords": "$timeout",
      "keywords": "$timeout $timeoutdecorator adds angular-mocks api decorator flush html js js-angular-release methods module ng ngmock partials service simple src verifynopendingtasks",
  ...
  "api/ngMock": {
    ...
    "searchTerms": {
      ...
      "keywords": "addition angular angular-mocks api code config controlled core doc-module-components extends html inject inspected js js-angular-release manner mock module ng ngmock partials services src support synchronous test tests unit",
      "members": ""
    }
  },
  "api/ngMockE2E": {
    ...
    "searchTerms": {
      ...
      "keywords": "$httpbackend angular angular-mocks api config currently e2e end-to-end html js js-angular-release mock mocks module ngmocke2e partials src suitable testing",
      "members": ""
    }
  },
  ...
  "api/ngMock/function/angular.mock.module": {
    ...
    "searchTerms": {
      ...
      "keywords": "access aliases angular angular-mocks anonymous api automatically code collects configuration configure created declared easy example fns function functions html initialization inject injector jasmine js js-angular-release key literal loaded mocha mock module modules ng ngmock number object partials passed published registered registers represented returned running src string tests usage values window",
      "members": ""
    }
  },
  "api/ngMock/function/angular.mock.inject": {
    ...
    "searchTerms": {
      ...
      "keywords": "$injector $provide _myservice_ access aliases angular angular-mocks api app arguments assign auto beforeeach block body clauses creates declared default defined describe dostuff easy enclosed erroraddingdeclarationlocationstack example expect fns function functions help hide html ignored inject injectable injected injector inside instance jasmine js js-angular-release load loads method mocha mock mode module modules multiple myapp myapplicationmodule myservice ng ngmock number optionally outer overridden override parameter parameters partials problem provide published reference references resolved resolving reuse running scope series src strings takes test tests toequal typical underscores v1 var variable version window wrap wrapping wraps",
      "members": ""
    }
  },
  "api/ngResource": {
    ...
    "searchTerms": {
      ...
      "keywords": "$resource angular-resource api doc-module-components html interaction js js-angular-release module ngresource partials provider resource restful service services src support usage",
      "members": ""
    }
  },
  ...
  "api/ngRoute": {
    ...
    "searchTerms": {
      ...
      "keywords": "$route angular angular-route api apps configuring deeplinking directives doc-module-components example html js js-angular-release module ngroute ngroutemodule partials route routing services src",
      "members": ""
    }
  },
  ...
  "api/ngSanitize/filter/linky": {
    ...
    "searchTerms": {
      "titleWords": "linky",
      "keywords": "address api email example-example66 filter finds frame function html html-linkified http input installed js js-angular-release links linky linky_expression module named ng-bind-html ngsanitize open partials plain requires src supports target text turns window",
      "members": ""
    }
  },
  "api/ngSanitize": {
    ...
    "searchTerms": {
      ...
      "keywords": "$sanitize $sanitizeprovider angular-sanitize api doc-module-components functionality html js js-angular-release module ngsanitize partials sanitize src usage",
      "members": ""
    }
  },
  ...
  "api/ngTouch/directive/ngSwipeLeft": {
    ...
    "searchTerms": {
      ...
      "keywords": "$event add api behavior click custom designed device devices directive disable dom drag element evaluate example-example69 expression finger functionality guide html installed js js-angular-release left leftward makeswipedirective module mouse ng-swipe-disable-mouse ng-swipe-left ng-swipe-right ngswipe ngswipeleft ngtouch object partials quick requires right-to-left slide src swipe swiped touch-based touchscreen work",
      "members": ""
    }
  },
  "api/ngTouch/directive/ngSwipeRight": {
    ...
    "searchTerms": {
      ...
      "keywords": "$event api behavior click custom designed device devices directive drag element evaluate example-example70 expression finger guide html installed js js-angular-release left-to-right makeswipedirective module mouse ngswipe ngswiperight ngtouch object partials quick requires rightward slide src swipe swiped touch-based touchscreen work",
      "members": ""
    }
  },
  ...
  "error/$location/nobase": {
    ...
    "name": "nobase",
    "area": "error",
    "outputPath": "partials/error/$location/nobase.html",
    "path": "error/$location/nobase",
    "searchTerms": {
      "titleWords": "$location:nobase",
      "keywords": "$location $locationprovider absolute additionally angular api app application apps base broken configure context correct deployed deploying didn docs don easier easy enabled entry error fallback feat hard hashbang history href html html5 html5mode https js-angular-release mechanism migrate mode moved mozilla ng ngdoc nobase order org point prevent profile provided provider pushstate relative require requirement requires resolve root set sub-context subcontext support tag url urls userprofile won work worked write wrong",
      "members": ""
    }
  },
  "error/$parse/isecdom": {
  ...
  "error/$q/norslvr": {
    ...
    "name": "norslvr",
    "area": "error",
    "outputPath": "partials/error/$q/norslvr.html",
    "path": "error/$q/norslvr",
    "searchTerms": {
      "titleWords": "$q:norslvr",
      "keywords": "$q calling creating docs error function js-angular-release ngdoc norslvr occurs passed promise providing reject required resolver var waitforsomethingasync",
      "members": ""
    }
  },
  "error/$q/qcycle": {
    ...
    "name": "qcycle",
    "area": "error",
    "outputPath": "partials/error/$q/qcycle.html",
    "path": "error/$q/qcycle",
    "searchTerms": {
      "titleWords": "$q:qcycle",
      "keywords": "$q behavior defer docs error function https including js-angular-release mandates ngdoc occurs passed promise qcycle resolve resolving return returning spec the-promise-resolution-procedure throw typeerror var",
      "members": ""
    }
  },
  ...
  "error/ngModel/constexpr": {
    ...
    "searchTerms": {
      ...
      "keywords": "accept attributes checkbox conjunction constant constexpr docs error examples expression expressions include js-angular-release ng-false-value ng-model ng-true-value ngdoc ngfalsevalue ngmodel ngtruevalue non-constant somescopevalue somevalue truthyvalue type",
      "members": ""
    }
  },
  ...
  "error/ngRepeat/badident": {
    "docType": "error",
    "id": "ngRepeat:badident",
    "name": "badident",
    "area": "error",
    "outputPath": "partials/error/ngRepeat/badident.html",
    "path": "error/ngRepeat/badident",
    "searchTerms": {
      "titleWords": "ngRepeat:badident repeat",
      "keywords": "$even $first $last $middle $odd $parent alias assign badident collection collections declare directive docs error expression expressions filter filteredcollection foo html identifier include invalid item items js-angular-release names ng ng-repeat ngdoc ngrepeat null objects occurs processed property reserved resultofsomemethod scope simple syntax thrown undefined valid var",
      "members": ""
    }
  },
  ...
  "guide/$location": {
    ...
    "searchTerms": {
      ...
      "keywords": "$apply $compile $digest $location $locationprovider $observe $observers $provide $rootscope $watch $watchers $window _escaped_fragment_ _self absolute absurl access add addition address ajax allow allows anchors angular angularjs api apis app application applications appropriate attributes automatically aware bar base based basically beforeeach behave best bind binding bot break browser browsers button call called calls capability case cases caveats chain chaining change changed changes changing character characters check class clicks coalesces code commit comparing compose configuration configure connected content control conversion crawlable crawler crawling create creating current currently customizing decoded default depending describe differences differentiate differently directive directly displaying docroot docs document doesn dom domain don earlier element empty-corner-lt enable encode encoded encoding entire entry equivalents event example example-example71 example-location-hashbang-mode example-location-html5-mode examples exception expected exposes facilitate factory fake fall fallback false features file flag form format forward fragment frees full function future general getter getters gettersetter google guide handeled hasbang hash hashbang hashpath hashprefix hashsearch head history host href html html5 html5mode http ietf images img implement indexing initial inject input inside instances instantiated integrates integration interact intercept intercepts internal item jpg jquery-style js js-angular-release lead legacy level life-cycle link links loaded location lower lower-level main maintains management meta method methods migrating missing mode modern modes modified modify mozilla multiple mutations navigate navigation needing ng ng-model-options ngdoc ngmodel note notified notify object observe obtains older open opening operation option org original overview param parameters parses parsing parts pass passed path pathname perform performs phase phases point port prefix prefixes process processes propagate properties protocol provided pushed raw react read read-only recognize record records redirect redirection redirects reflected regular relative release releases reload reloads replace replaced replacing represents request requires requiring resets resolved responsibility retrieve retrigger return returned returns rewrite rewrites rewriting rewritten rules scope scripts scrolling search segments sending serve server server-side service services serviceundertest set setter setters side single slash snapshots special src starting suitable supplies support supported supports synced synchronization table tag target technique test testing time transparent transparently true two-way txt type update updated updatehash updates url urls user users values versa vice viewing w3 watch window work worry write",
      "members": ""
    }
  },
  "guide/animations": {
  ...
  "guide/production": {
    ...
    "area": "guide",
    "outputPath": "partials/guide/production.html",
    "path": "guide/production",
    "searchTerms": {
      "titleWords": "Running in Production",
      "keywords": "$compileprovider accessed adds angular angularjs app application attached attaches binding boost browser call class classes compiler config consider console corresponding created css data data-bound debug debuginfoenabled default directly disable disabling docs dom element elements function guide included interpolations isolatescope js js-angular-release method myapp ng ng-class ng-isolated-scope ng-scope ngbind ngbindhtml ngdoc nodes open overview performance production references reload reloadwithdebuginfo result running scope scopes things tools",
      "members": ""
    }
  },
  "guide/providers": {
  ...
  "api/ng/function": {
    ...
    "name": "function components in module:ng",
    "area": "api",
  ...
  "api/ng/directive": {
    ...
    "name": "directive components in module:ng",
    "area": "api",
  ...
  "api/ng/object": {
    "docType": "componentGroup",
    "id": "module:ng.object",
    "name": "object components in module:ng",
    "area": "api",
  ...
  "api/ng/type": {
    "docType": "componentGroup",
    "id": "module:ng.type",
    "name": "type components in module:ng",
    "area": "api",
  ...
  "api/ng/service": {
    ...
    "name": "service components in module:ng",
    "area": "api",
  ...
  "api/ng/provider": {
    ...
    "name": "provider components in module:ng",
    "area": "api",
  ...
  "api/ng/input": {
    "docType": "componentGroup",
    "id": "module:ng.input",
    "name": "input components in module:ng",
    "area": "api",
  ...
  "api/ng/filter": {
    "docType": "componentGroup",
    "id": "module:ng.filter",
    "name": "filter components in module:ng",
    "area": "api",
  ...
  "api/auto/service": {
    ...
    "name": "service components in module:auto",
    "area": "api",
  ...
  "api/ngAnimate/provider": {
    ...
    "name": "provider components in module:ngAnimate",
    "area": "api",
  ...
  "api/ngAnimate/service": {
    ...
    "name": "service components in module:ngAnimate",
    "area": "api",
  ...
  "api/ngCookies/service": {
    ...
    "name": "service components in module:ngCookies",
    "area": "api",
  ...
  "api/ngMessages/directive": {
    ...
    "name": "directive components in module:ngMessages",
    "area": "api",
  ...
  "api/ngMock/object": {
    ...
    "name": "object components in module:ngMock",
    "area": "api",
  ...
  "api/ngMock/provider": {
    ...
    "name": "provider components in module:ngMock",
    "area": "api",
  ...
  "api/ngMock/service": {
    ...
    "name": "service components in module:ngMock",
    "area": "api",
  ...
  "api/ngMock/type": {
    ...
    "name": "type components in module:ngMock",
    "area": "api",
  ...
  "api/ngMock/function": {
    ...
    "name": "function components in module:ngMock",
    "area": "api",
  ...
  "api/ngMockE2E/service": {
    ...
    "name": "service components in module:ngMockE2E",
    "area": "api",
  ...
  "api/ngResource/service": {
    ...
    "name": "service components in module:ngResource",
    "area": "api",
  ...
  "api/ngRoute/directive": {
    ...
    "name": "directive components in module:ngRoute",
    "area": "api",
  ...
  "api/ngRoute/provider": {
    ...
    "name": "provider components in module:ngRoute",
    "area": "api",
  ...
  "api/ngRoute/service": {
    ...
    "name": "service components in module:ngRoute",
    "area": "api",
  ...
  "api/ngSanitize/filter": {
    ...
    "name": "filter components in module:ngSanitize",
    "area": "api",
  ...
  "api/ngSanitize/service": {
    ...
    "name": "service components in module:ngSanitize",
    "area": "api",
  ...
  "api/ngTouch/directive": {
    ...
    "name": "directive components in module:ngTouch",
    "area": "api",
  ...
  "api/ngTouch/service": {
    ...
    "name": "service components in module:ngTouch",
    "area": "api",
  ...
  "script.js": {
    "docType": "example-js",
    "id": "example-example111/script.js",
    "outputPath": "examples/example-example111/script.js",
    "path": "script.js"
  },
  ...
  "style.css": {
    "docType": "example-css",
    "id": "example-example108/style.css",
    "outputPath": "examples/example-example108/style.css",
    "path": "style.css"
  },
  ...
  "protractor.js": {
    ...
    "id": "example-example110/protractor.js",
    "outputPath": "examples/example-example110/protractor.js",
    "path": "protractor.js"
  },
  ...
  "app.js": {
    "docType": "example-js",
    "id": "example-example77/app.js",
    "outputPath": "examples/example-example77/app.js",
    "path": "app.js"
  },
  ...
  "animations.css": {
    "docType": "example-css",
    "id": "example-example72/animations.css",
    "outputPath": "examples/example-example72/animations.css",
    "path": "animations.css"
  },
  ...
  "guide/undefined": {
    "docType": "example-manifest",
    "id": "example-example111-manifest",
    "outputPath": "examples/example-example111/manifest.json",
  ...
  "app.css": {
    "docType": "example-css",
    "id": "example-example77/app.css",
    "outputPath": "examples/example-example77/app.css",
    "path": "app.css"
  },
  ...
  "my-customer.html": {
    "docType": "example-html",
    "id": "example-example82/my-customer.html",
    "outputPath": "examples/example-example82/my-customer.html",
  ...
  "my-customer-iso.html": {
    "docType": "example-html",
    "id": "example-example83/my-customer-iso.html",
    "outputPath": "examples/example-example83/my-customer-iso.html",
  ...
  "my-customer-plus-vojta.html": {
    "docType": "example-html",
    "id": "example-example84/my-customer-plus-vojta.html",
    "outputPath": "examples/example-example84/my-customer-plus-vojta.html",
  ...
  "my-dialog.html": {
    "docType": "example-html",
    "id": "example-example87/my-dialog.html",
    "outputPath": "examples/example-example87/my-dialog.html",
    "path": "my-dialog.html"
  },
  ...
  "my-dialog-close.html": {
    "docType": "example-html",
    "id": "example-example88/my-dialog-close.html",
    "outputPath": "examples/example-example88/my-dialog-close.html",
  ...
  "my-tabs.html": {
    "docType": "example-html",
    "id": "example-example90/my-tabs.html",
    "outputPath": "examples/example-example90/my-tabs.html",
    "path": "my-tabs.html"
  },
  "my-pane.html": {
    "docType": "example-html",
    "id": "example-example90/my-pane.html",
    "outputPath": "examples/example-example90/my-pane.html",
    "path": "my-pane.html"
  },
  ...
  "error/$q": {
    ...
    "name": "$q",
    "area": "error",
    "outputPath": "partials/error/$q.html",
    "path": "error/$q"
  },
  "error/$resource": {
    "docType": "errorNamespace",
