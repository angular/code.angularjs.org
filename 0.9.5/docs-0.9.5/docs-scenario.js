...
describe('angular.scope.$postEval', function(){
  beforeEach(function(){
    browser().navigateTo('index.html#!angular.scope.$postEval');
  });
  // src/Scope.js:552
});
