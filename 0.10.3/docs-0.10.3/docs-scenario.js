describe("angular+jqlite", function() {
  ...
  describe("api/angular.service.$formFactory", function() {
    beforeEach(function() {
      browser().navigateTo("index-nocache.html#!/api/angular.service.$formFactory");
    });
...
describe("angular+jquery", function() {
  ...
  describe("api/angular.service.$formFactory", function() {
    beforeEach(function() {
      browser().navigateTo("index-jq-nocache.html#!/api/angular.service.$formFactory");
    });
