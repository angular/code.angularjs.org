<a href='https://github.com/angular/angular.js/edit/v1.4.x/src/ng/directive/form.js?message=docs(form)%3A%20describe%20your%20change...#L324' class='improve-docs btn btn-primary'><i class="glyphicon glyphicon-edit">&nbsp;</i>Improve this Doc</a>



<a href='https://github.com/angular/angular.js/tree/v1.4.9/src/ng/directive/form.js#L324' class='view-source pull-right btn btn-primary'>
  <i class="glyphicon glyphicon-zoom-in">&nbsp;</i>View Source
</a>


<header class="api-profile-header">
  <h1 class="api-profile-header-heading">form</h1>
...
this name.</p>
<h1 id="alias-link-ng-directive-ngform-ngform-">Alias: <a href="api/ng/directive/ngForm"><code>ngForm</code></a></h1>
...
Angular provides the <a href="api/ng/directive/ngForm"><code>ngForm</code></a> directive, which behaves identically to
<code>form</code> but can be nested. Nested forms can be useful, for example, if the validity of a sub-group
of controls needs to be determined.</p>
...
<li><code>ng-pending</code> is set if the form is pending.</li>
...
<h1 id="submitting-a-form-and-preventing-the-default-action">Submitting a form and preventing the default action</h1>
...
<ul>
<li><a href="api/ng/directive/ngSubmit">ngSubmit</a> directive on the form element</li>
<li><a href="api/ng/directive/ngClick">ngClick</a> directive on the first
button or input field of type submit (input[type=submit])</li>
</ul>
<p>To prevent double execution of the handler, use only one of the <a href="api/ng/directive/ngSubmit">ngSubmit</a>
or <a href="api/ng/directive/ngClick">ngClick</a> directives.
...
<p>Any pending <code>ngModelOptions</code> changes will take place immediately when an enclosing form is
submitted. Note that <code>ngClick</code> events will occur before the model is updated. Use <code>ngSubmit</code>
to have access to the updated model.</p>
<h2 id="animation-hooks">Animation Hooks</h2>
<p>Animations in ngForm are triggered when any of the associated CSS classes are added and removed.
These classes are: <code>.ng-pristine</code>, <code>.ng-dirty</code>, <code>.ng-invalid</code> and <code>.ng-valid</code> as well as any
other validations that are performed within the form. Animations in ngForm are similar to how
they work in ngClass and animations can be hooked into using CSS transitions, keyframes as well
as JS animations.</p>
<p>The following example shows a simple way to utilize CSS transitions to style a form element
...
<div>
  <a ng-click="openPlunkr('examples/example-example59', $event)" class="btn pull-right">
