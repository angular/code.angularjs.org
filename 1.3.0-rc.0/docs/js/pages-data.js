...
angular.module('pagesData', [])
  ...
  "api/ng/function/angular.reloadWithDebugInfo": {
    ...
    "searchTerms": {
      ...
      "keywords": "$compileprovider angular api application call current debug debuginfoenabled function js js-angular-release ng precedence reload reloadwithdebuginfo src takes turned"
    }
  },
  ...
  "api/ng/service/$compile": {
    ...
    "searchTerms": {
      "titleWords": "$compile",
      "keywords": "$attrs $compile $compileminerr $compileprovider $digest $element $observe $rootscope $sce $scope $set $transclude $watch access accessing accidentally actual add advantage alert alert-error alert-success alert-warning alias aliasing allow allowed allowing allows amount angular angularjs api application applied apply appropriate argument arguments array assigned associated assumed asynchronous attach attempt attr attribute attributes attrs augment automatic automatically avoid avoided behavior behavioural bi-directional bind binding bindings bindtocontroller bound bracket call called caller calling case cases change changed changes channel child children class classes clone cloneattachfn cloned clonedelement clonelinkinfn clonelinkingfn clones collect comment common communicate communication compilation compile compiled compiler compiles compiling component components comprehensive config configuration considered console containers content contents context contexts control controller controlleras controllers correct corresponding count create created creates creating creating-custom-directives_creating-directives_template-expanding-directive ctrl current custom data data-ng-bind deals declaration declared default defaults define defined defines definition deprecated derived desirable details developer difference differs directive directive-name-end directive-name-start directivedefinitionobject directivename directives document doesn dom eacm easily effects efficient element elements elm empty equivalent error errors evaluated example example-example5 examples exception execute executed execution exist exp expressed expression factory fail false feature flag fn form fourth fragment function functions futureparentelement gentle gettrustedresourceurl greater group guide hand handle hash hasn hello html iattrs ielement illustrate imperatively in-depth including increment infinite info inherit initial inject injectable injected inside instance instantiated instructions inter inter-communication interpolated interpolation introduction isolate isolated js js-angular-release link linked linking linkingfn list listener listeners loaded loading local localfn localmodel localname locals locate log logic loop lower main major manipulate manual manually map markup matching math mathml maxpriority migrates modify module multielement multiple my-attr my-directive mymodule names namespace needed ng ng:bind ngbind ngclick nginclude ngmodel ngtransclude nodes non_assignable_model_expression normal normalized notation null number numerical object objects observe optional options order original otherinjectables outer overflow override parameter parent parentmodel parents pass passed passing phase place point post post-link post-linking postlink practice pre pre-bound pre-link pre-linking prefix prefixed prelink priority private process produces properties property prototypically provided raised read reason receives recomended recommended recursively red-on-hover reference referenced reflect reflected registered registering registration release relying removed replace replacement representing request require required resides resp responsible restrict restricts result return returning returns reusable reverse root rule safe scenarios scope searching send service set setup share shared sibling siblingdirectivename simplified single sort source special specific src stack strictly string stringalias strings style subset supports suspended svg takes tattrs telement template templateelement templatenamespace templates templateurl terminal testing testing-transclusion-directives throw time top-level transclude transcluded transcludefn transcludes transclusion transformation transformations transforming tree true type typical typically undefined unspecified updated updating url usual v2 values var variable variety view walking watches ways widget work working works wrap wrapper x-ng-bind"
    }
  },
  ...
  "api/ng/input/input[date]": {
    ...
    "searchTerms": {
      ...
      "keywords": "adds angular api assignable attribute browser browsers case changes constraint control createdateinputtype cues data-bind default defined directive element entered error evaluates example example-date-input-directive executed expected expression form format greater html5 input instance interaction iso iso-8601 js js-angular-release key label max min model modern ng ngchange ngmodel ngmodeloptions ngrequired object placeholder property provide published read required sets src string support text timezone transformation true type user users valid validation"
    }
  },
  "api/ng/input/input[dateTimeLocal]": {
    ...
    "searchTerms": {
      ...
      "keywords": "adds angular api assignable attribute browser browsers case changes constraint control createdateinputtype data-bind datetime datetimelocal default defined directive element entered error evaluates example example-datetimelocal-input-directive executed expression form format greater html5 input instance interaction iso iso-8601 js js-angular-release key local max min model ng ngchange ngmodel ngmodeloptions ngrequired object property published read required sets src support text timezone transformation true user valid validation"
    }
  },
  "api/ng/input/input[time]": {
    ...
    "searchTerms": {
      ...
      "keywords": "adds angular api assignable attribute binding browser browsers case changes constraint control createdateinputtype data-bind default defined directive element entered error evaluates example example-time-input-directive executed expression form format greater hh html5 input instance interaction iso iso-8601 january js js-angular-release key local max min mm model ng ngchange ngmodel ngmodeloptions ngrequired object output property published read required sets src ss support text time timezone transformation true user valid validation"
    }
  },
  "api/ng/input/input[week]": {
    ...
    "searchTerms": {
      ...
      "keywords": "adds angular api assignable attribute browser browsers case changes constraint control createdateinputtype data-bind default defined directive element entered error evaluates example example-week-input-directive executed expression form format greater html5 input instance interaction iso iso-8601 js js-angular-release key max min model ng ngchange ngmodel ngmodeloptions ngrequired object property published read required sets src support text timezone transformation true user valid validation week week-of-the-year"
    }
  },
  ...
  "api/ng/type/ngModel.NgModelController": {
    ...
    "searchTerms": {
      ...
      "keywords": "$asyncvalidators $dirty $error $formatters $http $invalid $modelvalue $parsers $pending $pristine $sanitize $sce $setvalidity $touched $untouched $valid $validators $viewchangelisteners $viewvalue $watches achieve actual additional api applied argument arguments array asynchronous attribute automatically bad boolean bound browser browsers called changed changes code collaborate collection content contenteditable contents control controller convert css custom data-binding deals decide delivered depending desired directive directives display dom edited element error errors event events example example-ngmodelcontroller execute exist exists expected fails false focus format formatter formatting fulfill fulfilled function functions hash html5 http ignored include inline input interacted invalid js js-angular-release key level listener listening logic lost marks mind model modelvalue module ng ng-model ngmodel ngmodelcontroller ngsanitize note notice object older onclick operation order parallel parsers parsing passed passing perform pipeline place populate process promise provide provided purposefully push reads refers reject rejected remove rendering request required response result return returns sanitize server service services set src status string success synchronous tells test touppercase trigged true turn type undefined uniqueusername unsafe update updated updates user validation validationfn validations validator validators validcharacters validity values var view viewvalue work"
    }
  },
  ...
  "api/ng/directive/ngChange": {
    ...
    "searchTerms": {
      ...
      "keywords": "$parsers api change changed changes committed continued directive element evaluate evaluated event example-ngchange-directive expression form guide input invalid javascript js js-angular-release key leaves model ng ngchange ngchangedirective ngmodel note null onchange pipeline presses programmatically requires return returned src stay transformation triggers user"
    }
  },
  ...
  "api/ng/directive/ngModelOptions": {
    ...
    "searchTerms": {
      ...
      "keywords": "$rollbackviewvalue access action actual allows api apply attribute belonging bind blur boolean bound browser button called canceled change changes clear control controllers current custom debounce debounced debouncing default defines delay delimited determines directive displayed easiest empty enclosing escape event events example example-ngmodeloptions-directive-blur example-ngmodeloptions-directive-debounce example-ngmodeloptions-directive-getter-setter expires field fields focus focused form functions getter getters gettersetter input inputs inside instance integer invoke js js-angular-release key list loses making matches method milliseconds model nature ng ng-model-options ngclick ngmodel ngmodelcontroller ngmodeloptions ngmodeloptionsdirective ngsubmit note object occur options order override pending place pressed published read reference relevant reset scope set space special src string submit submitted supplied supported synchronized takes time timer timezone treat trigger triggers tuning type update updated updateon updates utc valid view"
    }
  },
  ...
  "api/ng/directive/ngBindTemplate": {
    ...
    "searchTerms": {
      ...
      "keywords": "api attribute box change content directive element elements enter eval example-example15 expressions form greeting html interpolation js js-angular-release multiple needed ng ngbind ngbindtemplate ngbindtemplatedirective option replaced span specifies src template text title watch"
    }
  },
  "api/ng/directive/ngBindHtml": {
    ...
    "searchTerms": {
      ...
      "keywords": "$sanitize $sce angular api bind binding bound bypass content contextual core creates current default dependencies directive element ensure escaping evaluate evaluating example example-example16 exception explicitly exploit expression functionality guide including innerhtml innerhtml-ed isn js js-angular-release module ng ngbind ngbindhtml ngbindhtmldirective ngsanitize note result safe sanitization sanitized secure service src strict trustashtml trusted unavailable utilize values"
    }
  },
  ...
  "api/ng/directive/ngClassOdd": {
    ...
    "searchTerms": {
      ...
      "keywords": "ac api applied array class conjunction delimited directive directives eval evaluation exactly example-example19 expression guide js js-angular-release names ng ngclass ngclasseven ngclassodd ngclassodddirective ngrepeat odd representing result rows scope space src string work"
    }
  },
  "api/ng/directive/ngClassEven": {
    ...
    "searchTerms": {
      ...
      "keywords": "ac api applied array class conjunction delimited directive directives eval evaluation exactly example-example20 expression guide js js-angular-release names ng ngclass ngclasseven ngclassevendirective ngclassodd ngrepeat odd representing result rows scope space src string work"
    }
  },
  ...
  "api/ng/directive/ngController": {
    ...
    "searchTerms": {
      ...
      "keywords": "$controllerprovider $route $scope access accessed accessible accessing adding advantages allowglobals angular api appear application apply aspect attach attached attaches automatically avoiding binding bindings binds boilerplates business called changes class classes clearing code common community components configured contact controller controllers current data declaration declare declared declaring decorate definition demonstrates design directive directly dom don easier easily editing element evaluates example example-ngcontroller example-ngcontrolleras executed expression form function functions generally globally globals greeting guide included inheritance injects inside instance js js-angular-release key logic manual markup masking methods mistake model model-view-controller models multiple mvc ng ng-controller ngcontroller ngcontrollerdirective ngroute note obvious option pattern primitives principles properties property propertyname prototypal published recommended reflected registered removing rendered route scope scopes second service settings settingscontroller1 settingscontroller2 simple source specifies src style styles supports syntax tab template update user values view worry writing"
    }
  },
  ...
  "api/ng/directive/ngFocus": {
    ...
    "searchTerms": {
      ...
      "keywords": "$apply $evalasync $event angularjs api behavior calling consistent custom directive ensure evaluate event executed executes expression fired focus guide input js js-angular-release ng ngclick ngeventdirs ngfocus note object scope select src synchronously textarea window"
    }
  },
  "api/ng/directive/ngBlur": {
    ...
    "searchTerms": {
      ...
      "keywords": "$apply $evalasync $event angularjs api behavior blur consistent custom directive dom ensure evaluate event executed executes expression fired focussed guide input js js-angular-release manipulations ng ngblur ngclick ngeventdirs note object removing scope select src synchronously textarea window"
    }
  },
  ...
  "api/ng/directive/ngTransclude": {
    ...
    "searchTerms": {
      ...
      "keywords": "api content directive dom eac element example-example47 existing inserted insertion js js-angular-release marks nearest ng ngtransclude ngtranscludedirective parent point removed src transcluded transclusion"
    }
  },
  ...
  "api/ng/service/$templateRequest": {
    ...
    "searchTerms": {
      ...
      "keywords": "$compile $http $templatecache $templaterequest $templaterequestprovider amount api contents data downloaded downloads empty error exception fails function http ignore ignorerequesterror inside js js-angular-release ng parameter pending promise provided request requests response service setting src stores success template templaterequest thrown thwarted total totalpendingrequests tpl true url"
    }
  },
  ...
  "api/ngMock/function/angular.mock.module": {
    ...
    "searchTerms": {
      ...
      "keywords": "access aliases angular angular-mocks anonymous api automatically code collects configuration configure created declared easy example fns function functions initialization inject injector jasmine js js-angular-release key literal loaded mocha mock module modules ng ngmock number object passed published registered registers represented returned running src string tests usage values window"
    }
  },
  ...
  "api/ngResource": {
    ...
    "searchTerms": {
      ...
      "keywords": "$resource api doc-module-components interaction js js-angular-release module ngresource provider resource restful service services src support usage"
    }
  },
