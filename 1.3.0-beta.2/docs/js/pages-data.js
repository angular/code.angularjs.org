...
angular.module('pagesData', [])
  ...
  "api/ng/filter/currency": {
    ...
    "searchTerms": {
      "titleWords": "currency",
      "keywords": "$1 amount api currency current default displayed example-example51 filter filters formats formatted html identifier input js js-angular-release locale module ng number partials provided src symbol"
    }
  },
  "api/ng/filter/number": {
    ...
    "searchTerms": {
      "titleWords": "number",
      "keywords": "api case computed current decimal decimalplaces default digit empty example-example52 filter filters format formats formatting fraction fractionsize html input js js-angular-release locale module ng number partials pattern places provided returned round rounded size src string text third"
    }
  },
  "api/ng/filter/date": {
    "docType": "filter",
  ...
  "api/ng/filter/json": {
    ...
    "searchTerms": {
      "titleWords": "json",
      "keywords": "allows api arrays automatically binding convert converted curly debugging double example-example54 filter filters html javascript js js-angular-release json module ng notation object partials primitive src string types"
    }
  },
  ...
  "api/ng/filter/limitTo": {
    ...
    "searchTerms": {
      "titleWords": "limitTo",
      "keywords": "api array copied creates elements example-example55 exceeds filter html input items js js-angular-release length limit limited limitto module negative ng number partials positive returned sign source src string sub-array substring trimmed"
    }
  },
  "api/ng/filter/orderBy": {
    ...
    "searchTerms": {
      "titleWords": "orderBy",
      "keywords": "angular api array ascending called comparator control copy descending determine elements equivalent evaluates example example-example56 expression filter function getter html items js js-angular-release module ng object operator optionally order orderby orders partials predicate predicates prefixed property result reverse sort sorted sorting source src string"
    }
  },
  "api/ng/service/$http": {
    "docType": "service",
  ...
  "api/ng/provider/$interpolateProvider": {
    ...
    "searchTerms": {
      ...
      "keywords": "$interpolateprovider api configuring defaults example-example58 html interpolate interpolation js js-angular-release markup module ng partials provider src"
    }
  },
  ...
  "api/ng/service/$log": {
    ...
    "searchTerms": {
      "titleWords": "$log",
      "keywords": "$log $logprovider $window api browser change console debug debugenabled debugging default example-example60 html implementation js js-angular-release log logging main message messages module ng partials purpose safely service simple simplify src troubleshooting writes"
    }
  },
  ...
  "api/ng/service/$window": {
    ...
    "searchTerms": {
      "titleWords": "$window",
      "keywords": "$window angular api browser coding current defined dependency directive evaluated example example-example62 expression expressions global globally html inadvertently javascript js js-angular-release mocked module ng ngclick object overridden partials problems refer reference removed respect risk scope service src testability testing variable window"
    }
  },
  "api/ngAnimate": {
    "docType": "module",
  ...
  "api/ngCookies/service/$cookies": {
    ...
    "searchTerms": {
      "titleWords": "$cookies",
      "keywords": "$cookies $eval access adding api browser cookies created current example-example63 exposed html installed js js-angular-release module ngcookies object partials properties read removing requires service simple src"
    }
  },
  ...
  "api/ngSanitize/filter/linky": {
    ...
    "searchTerms": {
      "titleWords": "linky",
      "keywords": "address api email example-example64 filter finds frame html html-linkified http input installed js js-angular-release links linky linky_expression module named ng-bind-html ngsanitize open partials plain requires src supports target text turns window"
    }
  },
  "api/ngSanitize": {
    "docType": "module",
  ...
  "undefined": {
    ...
    "id": "example-example110-manifest",
    "outputPath": "examples/example-example110/manifest.json"
  },
  "script.js": {
    "docType": "example-js",
