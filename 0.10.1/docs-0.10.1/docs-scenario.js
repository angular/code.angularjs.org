describe("angular+jqlite", function() {
  ...
  describe("api/angular.copy", function(){
    beforeEach(function(){
      browser().navigateTo("index.html#!/api/angular.copy");
    });
  ...
  describe("api/angular.equals", function(){
    beforeEach(function(){
      browser().navigateTo("index.html#!/api/angular.equals");
    });
  ...
  describe("api/angular.directive.ng:cloak", function(){
    beforeEach(function(){
      browser().navigateTo("index.html#!/api/angular.directive.ng:cloak");
    });
  ...
  describe("api/angular.scope.$id", function(){
    beforeEach(function(){
      browser().navigateTo("index.html#!/api/angular.scope.$id");
    });
  ...
  describe("api/angular.scope.$root", function(){
    beforeEach(function(){
      browser().navigateTo("index.html#!/api/angular.scope.$root");
    });
  ...
  describe("api/angular.scope.$parent", function(){
    beforeEach(function(){
      browser().navigateTo("index.html#!/api/angular.scope.$parent");
    });
  ...
  describe("api/angular.scope.$digest", function(){
    beforeEach(function(){
      browser().navigateTo("index.html#!/api/angular.scope.$digest");
    });
  ...
  describe("api/angular.scope.$destroy", function(){
    beforeEach(function(){
      browser().navigateTo("index.html#!/api/angular.scope.$destroy");
    });
  ...
  describe("api/angular.scope.$evalAsync", function(){
    beforeEach(function(){
      browser().navigateTo("index.html#!/api/angular.scope.$evalAsync");
    });
  ...
  describe("api/angular.scope.$apply", function(){
    beforeEach(function(){
      browser().navigateTo("index.html#!/api/angular.scope.$apply");
    });
  ...
  describe("api/angular.scope.$on", function(){
    beforeEach(function(){
      browser().navigateTo("index.html#!/api/angular.scope.$on");
    });
  ...
  describe("api/angular.scope.$emit", function(){
    beforeEach(function(){
      browser().navigateTo("index.html#!/api/angular.scope.$emit");
    });
  ...
  describe("api/angular.scope.$broadcast", function(){
    beforeEach(function(){
      browser().navigateTo("index.html#!/api/angular.scope.$broadcast");
    });
  ...
  describe("api/angular.service.$locale", function(){
    beforeEach(function(){
      browser().navigateTo("index.html#!/api/angular.service.$locale");
    });
  ...
  describe("api/angular.service.$routeParams", function(){
    beforeEach(function(){
      browser().navigateTo("index.html#!/api/angular.service.$routeParams");
    });
  ...
  describe("api/angular.service.$sniffer", function(){
    beforeEach(function(){
      browser().navigateTo("index.html#!/api/angular.service.$sniffer");
    });
  ...
  describe("api/angular.widget.ng:pluralize", function(){
    beforeEach(function(){
      browser().navigateTo("index.html#!/api/angular.widget.ng:pluralize");
    });
  ...
  describe("guide/dev_guide.i18n", function(){
    beforeEach(function(){
      browser().navigateTo("index.html#!/guide/dev_guide.i18n");
    });
  ...
  describe("guide/dev_guide.scopes.internals", function(){
    beforeEach(function(){
      browser().navigateTo("index.html#!/guide/dev_guide.scopes.internals");
    });
  ...
  describe("guide/dev_guide.services.$location", function(){
    beforeEach(function(){
      browser().navigateTo("index.html#!/guide/dev_guide.services.$location");
    });
...
describe("angular+jquery", function() {
  ...
  describe("api/angular.copy", function(){
    beforeEach(function(){
      browser().navigateTo("index-jq.html#!/api/angular.copy");
    });
  ...
  describe("api/angular.equals", function(){
    beforeEach(function(){
      browser().navigateTo("index-jq.html#!/api/angular.equals");
    });
  ...
  describe("api/angular.directive.ng:cloak", function(){
    beforeEach(function(){
      browser().navigateTo("index-jq.html#!/api/angular.directive.ng:cloak");
    });
  ...
  describe("api/angular.scope.$id", function(){
    beforeEach(function(){
      browser().navigateTo("index-jq.html#!/api/angular.scope.$id");
    });
  ...
  describe("api/angular.scope.$root", function(){
    beforeEach(function(){
      browser().navigateTo("index-jq.html#!/api/angular.scope.$root");
    });
  ...
  describe("api/angular.scope.$parent", function(){
    beforeEach(function(){
      browser().navigateTo("index-jq.html#!/api/angular.scope.$parent");
    });
  ...
  describe("api/angular.scope.$digest", function(){
    beforeEach(function(){
      browser().navigateTo("index-jq.html#!/api/angular.scope.$digest");
    });
  ...
  describe("api/angular.scope.$destroy", function(){
    beforeEach(function(){
      browser().navigateTo("index-jq.html#!/api/angular.scope.$destroy");
    });
  ...
  describe("api/angular.scope.$evalAsync", function(){
    beforeEach(function(){
      browser().navigateTo("index-jq.html#!/api/angular.scope.$evalAsync");
    });
  ...
  describe("api/angular.scope.$apply", function(){
    beforeEach(function(){
      browser().navigateTo("index-jq.html#!/api/angular.scope.$apply");
    });
  ...
  describe("api/angular.scope.$on", function(){
    beforeEach(function(){
      browser().navigateTo("index-jq.html#!/api/angular.scope.$on");
    });
  ...
  describe("api/angular.scope.$emit", function(){
    beforeEach(function(){
      browser().navigateTo("index-jq.html#!/api/angular.scope.$emit");
    });
  ...
  describe("api/angular.scope.$broadcast", function(){
    beforeEach(function(){
      browser().navigateTo("index-jq.html#!/api/angular.scope.$broadcast");
    });
  ...
  describe("api/angular.service.$locale", function(){
    beforeEach(function(){
      browser().navigateTo("index-jq.html#!/api/angular.service.$locale");
    });
  ...
  describe("api/angular.service.$routeParams", function(){
    beforeEach(function(){
      browser().navigateTo("index-jq.html#!/api/angular.service.$routeParams");
    });
  ...
  describe("api/angular.service.$sniffer", function(){
    beforeEach(function(){
      browser().navigateTo("index-jq.html#!/api/angular.service.$sniffer");
    });
  ...
  describe("api/angular.widget.ng:pluralize", function(){
    beforeEach(function(){
      browser().navigateTo("index-jq.html#!/api/angular.widget.ng:pluralize");
    });
  ...
  describe("guide/dev_guide.i18n", function(){
    beforeEach(function(){
      browser().navigateTo("index-jq.html#!/guide/dev_guide.i18n");
    });
  ...
  describe("guide/dev_guide.scopes.internals", function(){
    beforeEach(function(){
      browser().navigateTo("index-jq.html#!/guide/dev_guide.scopes.internals");
    });
  ...
  describe("guide/dev_guide.services.$location", function(){
    beforeEach(function(){
      browser().navigateTo("index-jq.html#!/guide/dev_guide.services.$location");
    });
